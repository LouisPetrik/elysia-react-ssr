...
var require_react_development = __commonJS((exports, module) => {
  (function() {
    ...
    function printWarning(level, format, args, currentStack) {
      ReactSharedInternals.getCurrentStack && (currentStack = ReactSharedInternals.getCurrentStack(currentStack), currentStack !== "" && (format += "%s", args = args.concat([currentStack])));
      args.unshift(format);
    ...
    function checkKeyStringCoercion(value) {
      ...
      if (JSCompiler_inline_result)
        return JSCompiler_inline_result = typeof Symbol === "function" && Symbol.toStringTag && value[Symbol.toStringTag] || value.constructor.name || "Object", error$jscomp$0("The provided key is an unsupported type %s. This value must be coerced to a string before using it here.", JSCompiler_inline_result), testStringCoercion(value);
    }
    function getComponentNameFromType(type) {
      ...
      if (typeof type === "object")
        switch (typeof type.tag === "number" && error$jscomp$0("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."), type.$$typeof) {
    ...
    function describeNativeComponentFrame(fn, construct) {
      ...
      try {
        ...
        if (sampleStack && controlStack) {
          ...
          for (sampleStack = _RunInRootFrame$Deter = 0;_RunInRootFrame$Deter < sampleLines.length && !sampleLines[_RunInRootFrame$Deter].includes("DetermineComponentFrameRoot"); )
          ...
          for (;1 <= _RunInRootFrame$Deter && 0 <= sampleStack; _RunInRootFrame$Deter--, sampleStack--)
            if (sampleLines[_RunInRootFrame$Deter] !== controlLines[sampleStack]) {
              if (_RunInRootFrame$Deter !== 1 || sampleStack !== 1) {
                do
    ...
    function defineKeyPropWarningGetter(props, displayName) {
      function warnAboutAccessingKey() {
        specialPropKeyWarningShown || (specialPropKeyWarningShown = true, error$jscomp$0("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://react.dev/link/special-props)", displayName));
      }
    ...
    function elementRefGetterWithDeprecationWarning() {
      ...
      didWarnAboutElementRef[componentName] || (didWarnAboutElementRef[componentName] = true, error$jscomp$0("Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release."));
    ...
    function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
      ...
      if (isArrayImpl(children))
        ...
        for (i === children.entries && (didWarnAboutMaps || warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = true), children = i.call(children), i = 0;!(nameSoFar = children.next()).done; )
    ...
    function lazyInitializer(payload) {
      ...
      if (payload._status === 1)
        return ctor = payload._result, ctor === undefined && error$jscomp$0("lazy: Expected the result of a dynamic import() call. Instead received: %s\n\nYour code should look like: \n  const MyComponent = lazy(() => import('./MyComponent'))\n\nDid you accidentally put curly braces around the import?", ctor), "default" in ctor || error$jscomp$0("lazy: Expected the result of a dynamic import() call. Instead received: %s\n\nYour code should look like: \n  const MyComponent = lazy(() => import('./MyComponent'))", ctor), ctor.default;
      throw payload._result;
    }
    function resolveDispatcher() {
      var dispatcher = ReactSharedInternals.H;
      dispatcher === null && error$jscomp$0("Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:\n1. You might have mismatching versions of React and the renderer (such as React DOM)\n2. You might be breaking the Rules of Hooks\n3. You might have more than one copy of React in the same app\nSee https://react.dev/link/invalid-hook-call for tips about how to debug and fix this problem.");
      return dispatcher;
    }
    function noop() {
    }
    ...
    exports.act = function(callback) {
      ...
      if (result !== null && typeof result === "object" && typeof result.then === "function") {
        ...
        queueSeveralMicrotasks(function() {
          didAwaitActCall || didWarnNoAwaitAct || (didWarnNoAwaitAct = true, error$jscomp$0("You called act(async () => ...) without await. This could lead to unexpected testing behaviour, interleaving multiple act calls and mixing their scopes. You should - await act(async () => ...);"));
        });
        return {
      ...
      prevActScopeDepth === 0 && (flushActQueue(queue), queue.length !== 0 && queueSeveralMicrotasks(function() {
        didAwaitActCall || didWarnNoAwaitAct || (didWarnNoAwaitAct = true, error$jscomp$0("A component suspended inside an `act` scope, but the `act` call was not awaited. When testing React components that depend on asynchronous data, you must await the result:\n\nawait act(() => ...)"));
      }), ReactSharedInternals.actQueue = null);
      if (0 < ReactSharedInternals.thrownErrors.length)
    ...
    exports.createElement = function(type, config, children) {
      ...
      typeString = null;
      if (config != null)
        for (propName in didWarnAboutOldJSXRuntime || !("__self" in config) || "key" in config || (didWarnAboutOldJSXRuntime = true, warn("Your app (or one of its dependencies) is using an outdated JSX transform. Update to the modern JSX transform for faster performance: https://react.dev/link/new-jsx-transform")), hasValidRef(config), hasValidKey(config) && (checkKeyStringCoercion(config.key), typeString = "" + config.key), config)
    ...
    exports.forwardRef = function(render) {
      render != null && render.$$typeof === REACT_MEMO_TYPE ? error$jscomp$0("forwardRef requires a render function but received a `memo` component. Instead of forwardRef(memo(...)), use memo(forwardRef(...)).") : typeof render !== "function" ? error$jscomp$0("forwardRef requires a render function but was given %s.", render === null ? "null" : typeof render) : render.length !== 0 && render.length !== 2 && error$jscomp$0("forwardRef render functions accept exactly two parameters: props and ref. %s", render.length === 1 ? "Did you forget to use the ref parameter?" : "Any additional parameter will be undefined.");
      render != null && render.defaultProps != null && error$jscomp$0("forwardRef render functions do not support defaultProps. Did you accidentally pass a React component?");
    ...
    exports.memo = function(type, compare) {
      isValidElementType(type) || error$jscomp$0("memo: The first argument must be a component. Instead received: %s", type === null ? "null" : typeof type);
      compare = {
...
var require_react_dom_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    function error(format) {
      ...
      ReactSharedInternals.getCurrentStack && (_key2 = ReactSharedInternals.getCurrentStack(_key2), _key2 !== "" && (_len2 += "%s", args = args.concat([_key2])));
      args.unshift(_len2);
    ...
    function createPortal$1(children, containerInfo, implementation) {
      ...
      JSCompiler_inline_result && (error("The provided key is an unsupported type %s. This value must be coerced to a string before using it here.", typeof Symbol === "function" && Symbol.toStringTag && key[Symbol.toStringTag] || key.constructor.name || "Object"), testStringCoercion(key));
      return {
    ...
    var Internals = {
      ...
      p: 0,
      findDOMNode: null
    }, ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, REACT_PORTAL_TYPE = Symbol.for("react.portal");
    ...
    exports.preconnect = function(href, options) {
      typeof href === "string" && href ? options != null && typeof options !== "object" ? error("ReactDOM.preconnect(): Expected the `options` argument (second) to be an object but encountered %s instead. The only supported option at this time is `crossOrigin` which accepts a string.", getValueDescriptorExpectingEnumForWarning(options)) : options != null && typeof options.crossOrigin !== "string" && error("ReactDOM.preconnect(): Expected the `crossOrigin` option (second argument) to be a string but encountered %s instead. Try removing this option or passing a string value instead.", getValueDescriptorExpectingObjectForWarning(options.crossOrigin)) : error("ReactDOM.preconnect(): Expected the `href` argument (first) to be a non-empty string but encountered %s instead.", getValueDescriptorExpectingObjectForWarning(href));
    ...
    exports.preinit = function(href, options) {
      typeof href === "string" && href ? options == null || typeof options !== "object" ? error("ReactDOM.preinit(): Expected the `options` argument (second) to be an object with an `as` property describing the type of resource to be preinitialized but encountered %s instead.", getValueDescriptorExpectingEnumForWarning(options)) : options.as !== "style" && options.as !== "script" && error('ReactDOM.preinit(): Expected the `as` property in the `options` argument (second) to contain a valid value describing the type of resource to be preinitialized but encountered %s instead. Valid values for `as` are "style" and "script".', getValueDescriptorExpectingEnumForWarning(options.as)) : error("ReactDOM.preinit(): Expected the `href` argument (first) to be a non-empty string but encountered %s instead.", getValueDescriptorExpectingObjectForWarning(href));
...
var require_react_dom_client_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    function findHostInstancesForRefresh(root2, families) {
      ...
      findHostInstancesForMatchingFibersRecursively(root2.current, families, hostInstances);
    ...
    function requiredContext(c) {
      c === null && error$jscomp$0("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.");
      return c;
    }
    ...
    function checkAttributeStringCoercion(value, attributeName) {
      if (willCoercionThrow(value))
        return error$jscomp$0("The provided `%s` attribute is an unsupported type %s. This value must be coerced to a string before using it here.", attributeName, typeName(value)), testStringCoercion(value);
    }
    function checkCSSPropertyStringCoercion(value, propName) {
      if (willCoercionThrow(value))
        return error$jscomp$0("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before using it here.", propName, typeName(value)), testStringCoercion(value);
    }
    function checkFormFieldValueStringCoercion(value) {
      if (willCoercionThrow(value))
        return error$jscomp$0("Form field values (value, checked, defaultValue, or defaultChecked props) must be strings, not %s. This value must be coerced to a string before using it here.", typeName(value)), testStringCoercion(value);
    }
    function injectInternals(internals) {
      ...
      if (!hook.supportsFiber)
        return error$jscomp$0("The installed version of React DevTools is too old and will not work with the current version of React. Please update React DevTools. https://react.dev/link/react-devtools"), true;
      try {
    ...
    function onCommitRoot$1(root2, eventPriority) {
      if (injectedHook && typeof injectedHook.onCommitFiberRoot === "function")
        try {
          ...
          hasLoggedError || (hasLoggedError = true, error$jscomp$0("React instrumentation encountered an error: %s", err));
        }
    }
    function setIsStrictModeForDevtools(newIsStrictMode) {
      typeof log$1 === "function" && (unstable_setDisableYieldValue2(newIsStrictMode), suppressWarning = newIsStrictMode);
    ...
    function getNextLanes(root2, wipLanes) {
      ...
      nonIdlePendingLanes !== 0 ? (pendingLanes = nonIdlePendingLanes & ~suspendedLanes, pendingLanes !== 0 ? nextLanes = getHighestPriorityLanes(pendingLanes) : (root2 &= nonIdlePendingLanes, root2 !== 0 && (nextLanes = getHighestPriorityLanes(root2)))) : (pendingLanes &= ~suspendedLanes, pendingLanes !== 0 ? nextLanes = getHighestPriorityLanes(pendingLanes) : root2 !== 0 && (nextLanes = getHighestPriorityLanes(root2)));
      return nextLanes === 0 ? 0 : wipLanes !== 0 && wipLanes !== nextLanes && (wipLanes & suspendedLanes) === 0 && (suspendedLanes = nextLanes & -nextLanes, root2 = wipLanes & -wipLanes, suspendedLanes >= root2 || suspendedLanes === DefaultLane && (root2 & TransitionLanes) !== 0) ? wipLanes : nextLanes;
    }
    ...
    function getLanesToRetrySynchronouslyOnError(root2, originallyAttemptedLanes) {
      ...
      return root2 !== 0 ? root2 : root2 & OffscreenLane ? OffscreenLane : 0;
    }
    function claimNextTransitionLane() {
      var lane = nextTransitionLane;
      nextTransitionLane <<= 1;
      (nextTransitionLane & TransitionLanes) === 0 && (nextTransitionLane = 128);
      return lane;
    }
    function claimNextRetryLane() {
      var lane = nextRetryLane;
      nextRetryLane <<= 1;
      (nextRetryLane & RetryLanes) === 0 && (nextRetryLane = 4194304);
      return lane;
    }
    ...
    function markRootFinished(root2, remainingLanes, spawnedLane) {
      ...
      for (var { expirationTimes, hiddenUpdates } = root2;0 < noLongerPendingLanes; ) {
        ...
        if (hiddenUpdatesForLane !== null)
          for (hiddenUpdates[index] = null, index = 0;index < hiddenUpdatesForLane.length; index++) {
            ...
            update !== null && (update.lane &= ~OffscreenLane);
          }
    ...
    function checkControlledValueProps(tagName, props) {
      hasReadOnlyValue[props.type] || props.onChange || props.onInput || props.readOnly || props.disabled || props.value == null || (tagName === "select" ? error$jscomp$0("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set `onChange`.") : error$jscomp$0("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`."));
      props.onChange || props.readOnly || props.disabled || props.checked == null || error$jscomp$0("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.");
    }
    ...
    function validateInputProps(element, props) {
      props.checked === undefined || props.defaultChecked === undefined || didWarnCheckedDefaultChecked || (error$jscomp$0("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://react.dev/link/controlled-components", getCurrentFiberOwnerNameInDevOrNull() || "A component", props.type), didWarnCheckedDefaultChecked = true);
      props.value === undefined || props.defaultValue === undefined || didWarnValueDefaultValue$1 || (error$jscomp$0("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://react.dev/link/controlled-components", getCurrentFiberOwnerNameInDevOrNull() || "A component", props.type), didWarnValueDefaultValue$1 = true);
    }
    ...
    function validateOptionProps(element, props) {
      props.value == null && (typeof props.children === "object" && props.children !== null ? React.Children.forEach(props.children, function(child) {
        child == null || typeof child === "string" || typeof child === "number" || typeof child === "bigint" || didWarnInvalidChild || (didWarnInvalidChild = true, error$jscomp$0("Cannot infer the option value of complex children. Pass a `value` prop or use a plain string as children to <option>."));
      }) : props.dangerouslySetInnerHTML == null || didWarnInvalidInnerHTML || (didWarnInvalidInnerHTML = true, error$jscomp$0("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected.")));
      props.selected == null || didWarnSelectedSetOnOption || (error$jscomp$0("Use the `defaultValue` or `value` props on <select> instead of setting `selected` on <option>."), didWarnSelectedSetOnOption = true);
    }
    ...
    function validateSelectProps(element, props) {
      ...
      props.value === undefined || props.defaultValue === undefined || didWarnValueDefaultValue || (error$jscomp$0("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://react.dev/link/controlled-components"), didWarnValueDefaultValue = true);
    }
    function validateTextareaProps(element, props) {
      props.value === undefined || props.defaultValue === undefined || didWarnValDefaultVal || (error$jscomp$0("%s contains a textarea with both value and defaultValue props. Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://react.dev/link/controlled-components", getCurrentFiberOwnerNameInDevOrNull() || "A component"), didWarnValDefaultVal = true);
      props.children != null && props.value == null && error$jscomp$0("Use the `defaultValue` or `value` props instead of setting children on <textarea>.");
    }
    ...
    function setValueForStyle(style2, styleName, value) {
      ...
      isCustomProperty || (-1 < styleName.indexOf("-") ? warnedStyleNames.hasOwnProperty(styleName) && warnedStyleNames[styleName] || (warnedStyleNames[styleName] = true, error$jscomp$0("Unsupported style property %s. Did you mean %s?", styleName, camelize(styleName.replace(msPattern, "ms-")))) : badVendoredStyleNamePattern.test(styleName) ? warnedStyleNames.hasOwnProperty(styleName) && warnedStyleNames[styleName] || (warnedStyleNames[styleName] = true, error$jscomp$0("Unsupported vendor-prefixed style property %s. Did you mean %s?", styleName, styleName.charAt(0).toUpperCase() + styleName.slice(1))) : !badStyleValueWithSemicolonPattern.test(value) || warnedStyleValues.hasOwnProperty(value) && warnedStyleValues[value] || (warnedStyleValues[value] = true, error$jscomp$0('Style property values shouldn\'t contain a semicolon. Try "%s: %s" instead.', styleName, value.replace(badStyleValueWithSemicolonPattern, ""))), typeof value === "number" && (isNaN(value) ? warnedForNaNValue || (warnedForNaNValue = true, error$jscomp$0("`NaN` is an invalid value for the `%s` css style property.", styleName)) : isFinite(value) || warnedForInfinityValue || (warnedForInfinityValue = true, error$jscomp$0("`Infinity` is an invalid value for the `%s` css style property.", styleName))));
    ...
    function validateProperty$1(tagName, name) {
      ...
      if (rARIACamel$1.test(name)) {
        ...
        if (tagName == null)
          return error$jscomp$0("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", name), warnedProperties$1[name] = true;
        if (name !== tagName)
          return error$jscomp$0("Invalid ARIA attribute `%s`. Did you mean `%s`?", name, tagName), warnedProperties$1[name] = true;
      }
      if (rARIA$1.test(name)) {
        ...
        name !== tagName && (error$jscomp$0("Unknown ARIA attribute `%s`. Did you mean `%s`?", name, tagName), warnedProperties$1[name] = true);
      }
      return true;
    }
    function validateProperties$2(type, props) {
      ...
      invalidProps.length === 1 ? error$jscomp$0("Invalid aria prop %s on <%s> tag. For details, see https://react.dev/link/invalid-aria-props", props, type) : 1 < invalidProps.length && error$jscomp$0("Invalid aria props %s on <%s> tag. For details, see https://react.dev/link/invalid-aria-props", props, type);
    }
    function validateProperty(tagName, name, value, eventRegistry) {
      ...
      if (lowerCasedName === "onfocusin" || lowerCasedName === "onfocusout")
        return error$jscomp$0("React uses onFocus and onBlur instead of onFocusIn and onFocusOut. All React events are normalized to bubble, so onFocusIn and onFocusOut are not needed/supported by React."), warnedProperties[name] = true;
      ...
      if (eventRegistry != null) {
        ...
        if (eventRegistry != null)
          return error$jscomp$0("Invalid event handler property `%s`. Did you mean `%s`?", name, eventRegistry), warnedProperties[name] = true;
        if (EVENT_NAME_REGEX.test(name))
          return error$jscomp$0("Unknown event handler property `%s`. It will be ignored.", name), warnedProperties[name] = true;
      } else if (EVENT_NAME_REGEX.test(name))
        return INVALID_EVENT_NAME_REGEX.test(name) && error$jscomp$0("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", name), warnedProperties[name] = true;
      if (rARIA.test(name) || rARIACamel.test(name))
        return true;
      if (lowerCasedName === "innerhtml")
        return error$jscomp$0("Directly setting property `innerHTML` is not permitted. For more information, lookup documentation on `dangerouslySetInnerHTML`."), warnedProperties[name] = true;
      if (lowerCasedName === "aria")
        return error$jscomp$0("The `aria` attribute is reserved for future use in React. Pass individual `aria-` attributes instead."), warnedProperties[name] = true;
      if (lowerCasedName === "is" && value !== null && value !== undefined && typeof value !== "string")
        return error$jscomp$0("Received a `%s` for a string attribute `is`. If this is expected, cast the value to a string.", typeof value), warnedProperties[name] = true;
      if (typeof value === "number" && isNaN(value))
        return error$jscomp$0("Received NaN for the `%s` attribute. If this is expected, cast the value to a string.", name), warnedProperties[name] = true;
      if (possibleStandardNames.hasOwnProperty(lowerCasedName)) {
        if (lowerCasedName = possibleStandardNames[lowerCasedName], lowerCasedName !== name)
          return error$jscomp$0("Invalid DOM property `%s`. Did you mean `%s`?", name, lowerCasedName), warnedProperties[name] = true;
      } else if (name !== lowerCasedName)
        return error$jscomp$0("React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.", name, lowerCasedName), warnedProperties[name] = true;
      switch (name) {
      ...
      switch (typeof value) {
        ...
        case "string":
          if (value === "false" || value === "true") {
            ...
            error$jscomp$0("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", value, name, value === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', name, value);
    ...
    function warnUnknownProperties(type, props, eventRegistry) {
      ...
      unknownProps.length === 1 ? error$jscomp$0("Invalid value for prop %s on <%s> tag. Either remove it from the element, or pass a string or number value to keep it in the DOM. For details, see https://react.dev/link/attribute-behavior ", props, type) : 1 < unknownProps.length && error$jscomp$0("Invalid values for props %s on <%s> tag. Either remove them from the element, or pass a string or number value to keep them in the DOM. For details, see https://react.dev/link/attribute-behavior ", props, type);
    }
    ...
    function restoreSelection(priorSelectionInformation) {
      ...
      if (curFocusedElem !== priorFocusedElem && priorFocusedElem && priorFocusedElem.ownerDocument && containsNode(priorFocusedElem.ownerDocument.documentElement, priorFocusedElem)) {
        if (priorSelectionRange !== null && hasSelectionCapabilities(priorFocusedElem)) {
          if (curFocusedElem = priorSelectionRange.start, priorSelectionInformation = priorSelectionRange.end, priorSelectionInformation === undefined && (priorSelectionInformation = curFocusedElem), "selectionStart" in priorFocusedElem)
        ...
        for (priorSelectionInformation = priorFocusedElem;priorSelectionInformation = priorSelectionInformation.parentNode; )
          priorSelectionInformation.nodeType === 1 && curFocusedElem.push({
    ...
    function markUpdateLaneFromFiberToRoot(sourceFiber, update, lane) {
      ...
      isHidden && update !== null && sourceFiber.tag === 3 && (parent = sourceFiber.stateNode, isHidden = 31 - clz32(lane), parent = parent.hiddenUpdates, sourceFiber = parent[isHidden], sourceFiber === null ? parent[isHidden] = [update] : sourceFiber.push(update), update.lane = lane | OffscreenLane);
    }
    ...
    function scheduleFibersWithFamiliesRecursively(fiber, updatedFamilies, staleFamilies) {
      ...
      if (type || needsRender)
        alternate = enqueueConcurrentRenderForLane(fiber, SyncLane), alternate !== null && scheduleUpdateOnFiber(alternate, fiber, SyncLane);
    ...
    function findHostInstancesForMatchingFibersRecursively(fiber, types, hostInstances) {
      var { child, sibling, type } = fiber, candidateType = null;
      switch (fiber.tag) {
        case 0:
        case 15:
        case 1:
      ...
      type = false;
      candidateType !== null && types.has(candidateType) && (type = true);
      if (type)
        a: {
          b:
            for (child = fiber, candidateType = false;; ) {
              if (child.tag === 5 || child.tag === 26 || child.tag === 27)
    ...
    function createCapturedValueAtFiber(value, source) {
      if (typeof value === "object" && value !== null) {
        ...
        typeof stack !== "string" && (stack = getStackByFiberInDevAndProd(source), CapturedStacks.set(value, stack));
      } else
    ...
    function findNotableNode(node, indent) {
      return node.serverProps === undefined && node.serverTail.length === 0 && node.children.length === 1 && 3 < node.distanceFromLeaf && node.distanceFromLeaf > idealDepth - indent ? findNotableNode(node.children[0], indent) : node;
    }
    ...
    function describePropertiesDiff(clientObject, serverObject, indent) {
      ...
      for (var _propName in remainingServerProperties)
        remainingServerProperties.hasOwnProperty(_propName) && (clientObject = describeValue(remainingServerProperties[_propName], maxRowLength - 2 * indent - _propName.length - 2), properties += removed(indent) + _propName + ": " + clientObject + "\n");
      return properties;
    }
    ...
    function describeNode(node, indent) {
      ...
      if (node.fiber.tag === 6)
        ...
        if (node.serverProps === undefined) {
          ...
          node.serverProps === null ? debugInfo = describeExpandedElement(serverComponentName, i, added(indent)) : typeof node.serverProps === "string" ? error$jscomp$0("Should not have matched a non HostText fiber to a Text node. This is a bug in React.") : (debugInfo = describeElementDiff(serverComponentName, i, node.serverProps, indent), indent++);
      var propName = "";
      i = node.fiber.child;
      ...
      for (i = 0;i < node.length; i++)
        serverComponentName = node[i], propName = typeof serverComponentName === "string" ? propName + (removed(indent) + describeTextNode(serverComponentName, maxRowLength - 2 * indent) + "\n") : propName + describeExpandedElement(serverComponentName.type, serverComponentName.props, removed(indent));
    ...
    function emitPendingHydrationWarnings() {
      ...
      diffRoot !== null && (hydrationDiffRootDEV = null, diffRoot = describeDiff(diffRoot), error$jscomp$0("A tree hydrated but some attributes of the server rendered HTML didn't match the client properties. This won't be patched up. This can happen if a SSR-ed Client Component used:\n\n- A server/client branch `if (typeof window !== 'undefined')`.\n- Variable input such as `Date.now()` or `Math.random()` which changes each time it's called.\n- Date formatting in a user's locale which doesn't match the server.\n- External changing data without sending a snapshot of it along with the HTML.\n- Invalid HTML tag nesting.\n\nIt can also happen if the client has a browser extension installed which messes with the HTML before React loaded.\n\n%s%s", "https://react.dev/link/hydration-mismatch", diffRoot));
    }
    ...
    function trackUsedThenable(thenableState2, thenable, index) {
      ...
      index === undefined ? trackedThenables.push(thenable) : index !== thenable && (thenableState2.didWarnAboutUncachedPromise || (thenableState2.didWarnAboutUncachedPromise = true, error$jscomp$0("A component was suspended by an uncached promise. Creating promises inside a Client Component or hook is not yet supported, except via a Suspense-compatible library or framework.")), thenable.then(noop$3, noop$3), thenable = index);
      switch (thenable.status) {
        case "fulfilled":
          return thenable.value;
        case "rejected":
    ...
    function validateFragmentProps(element, fiber, returnFiber) {
      for (var keys = Object.keys(element.props), i = 0;i < keys.length; i++) {
        ...
        if (key !== "children" && key !== "key") {
          fiber === null && (fiber = createFiberFromElement(element, returnFiber.mode, 0), fiber.return = returnFiber);
    ...
    function createChildReconciler(shouldTrackSideEffects) {
      ...
      function updateTextNode(returnFiber, current2, textContent, lanes) {
        if (current2 === null || current2.tag !== 6)
          return current2 = createFiberFromText(textContent, returnFiber.mode, lanes), current2.return = returnFiber, current2._debugInfo = currentDebugInfo, current2;
      ...
      function updateFragment(returnFiber, current2, fragment, lanes, key) {
        if (current2 === null || current2.tag !== 7)
          return current2 = createFiberFromFragment(fragment, returnFiber.mode, lanes, key), current2.return = returnFiber, current2._debugInfo = currentDebugInfo, current2;
      ...
      function createChild(returnFiber, newChild, lanes) {
        if (typeof newChild === "string" && newChild !== "" || typeof newChild === "number" || typeof newChild === "bigint")
          return newChild = createFiberFromText("" + newChild, returnFiber.mode, lanes), newChild.return = returnFiber, newChild._debugInfo = currentDebugInfo, newChild;
        if (typeof newChild === "object" && newChild !== null) {
          ...
          if (isArrayImpl(newChild) || getIteratorFn(newChild))
            return lanes = createFiberFromFragment(newChild, returnFiber.mode, lanes, null), lanes.return = returnFiber, returnFiber = pushDebugInfo(newChild._debugInfo), lanes._debugInfo = currentDebugInfo, currentDebugInfo = returnFiber, lanes;
          ...
          if (newChild.$$typeof === REACT_CONTEXT_TYPE)
            return createChild(returnFiber, readContextDuringReconciliation(returnFiber, newChild, lanes), lanes);
      ...
      function updateSlot(returnFiber, oldFiber, newChild, lanes) {
        ...
        if (typeof newChild === "object" && newChild !== null) {
          ...
          if (newChild.$$typeof === REACT_CONTEXT_TYPE)
            return updateSlot(returnFiber, oldFiber, readContextDuringReconciliation(returnFiber, newChild, lanes), lanes);
          throwOnInvalidObjectType(returnFiber, newChild);
        }
        typeof newChild === "function" && warnOnFunctionType(returnFiber, newChild);
        typeof newChild === "symbol" && warnOnSymbolType(returnFiber, newChild);
      ...
      function updateFromMap(existingChildren, returnFiber, newIdx, newChild, lanes) {
        ...
        if (typeof newChild === "object" && newChild !== null) {
          ...
          if (newChild.$$typeof === REACT_CONTEXT_TYPE)
            return updateFromMap(existingChildren, returnFiber, newIdx, readContextDuringReconciliation(returnFiber, newChild, lanes), lanes);
          throwOnInvalidObjectType(returnFiber, newChild);
        }
        typeof newChild === "function" && warnOnFunctionType(returnFiber, newChild);
        typeof newChild === "symbol" && warnOnSymbolType(returnFiber, newChild);
      ...
      function reconcileChildFibersImpl(returnFiber, currentFirstChild, newChild, lanes) {
        ...
        if (typeof newChild === "object" && newChild !== null) {
          ...
          if (getIteratorFn(newChild)) {
            ...
            if (key === newChild) {
              if (returnFiber.tag !== 0 || Object.prototype.toString.call(returnFiber.type) !== "[object GeneratorFunction]" || Object.prototype.toString.call(key) !== "[object Generator]")
                didWarnAboutGenerators || error$jscomp$0("Using Iterators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. You can also use an Iterable that can iterate multiple times over the same items."), didWarnAboutGenerators = true;
            } else
              newChild.entries !== child || didWarnAboutMaps || (error$jscomp$0("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = true);
          ...
          if (newChild.$$typeof === REACT_CONTEXT_TYPE)
            return reconcileChildFibersImpl(returnFiber, currentFirstChild, readContextDuringReconciliation(returnFiber, newChild, lanes), lanes);
          throwOnInvalidObjectType(returnFiber, newChild);
        }
        if (typeof newChild === "string" && newChild !== "" || typeof newChild === "number" || typeof newChild === "bigint")
    ...
    function checkDepsAreArrayDev(deps) {
      deps === undefined || deps === null || isArrayImpl(deps) || error$jscomp$0("%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.", currentHookNameInDev, typeof deps);
    }
    function warnOnUseFormStateInDev() {
      var componentName2 = getComponentNameFromFiber(currentlyRenderingFiber$1);
      didWarnAboutUseFormState.has(componentName2) || (didWarnAboutUseFormState.add(componentName2), error$jscomp$0("ReactDOM.useFormState has been renamed to React.useActionState. Please update %s to use React.useActionState.", componentName2));
    }
    ...
    function areHookInputsEqual(nextDeps, prevDeps) {
      if (ignorePreviousDependencies)
        return false;
      if (prevDeps === null)
        return error$jscomp$0("%s received a final argument during this render, but not during the previous render. Even though the final argument is optional, its type cannot change between renders.", currentHookNameInDev), false;
    ...
    function renderWithHooks(current2, workInProgress2, Component, props, secondArg, nextRenderLanes) {
      ...
      shouldDoubleInvokeUserFnsInHooksDEV = nextRenderLanes = (workInProgress2.mode & 8) !== 0;
    ...
    function finishRenderingHooks(current2, workInProgress2) {
      ...
      hookTypesUpdateIndexDev = -1;
      current2 !== null && (current2.flags & 31457280) !== (workInProgress2.flags & 31457280) && error$jscomp$0("Internal React error: Expected static flag was missing. Please notify the React team.");
      ...
      current2 && (workInProgress2 = getComponentNameFromFiber(workInProgress2) || "Unknown", didWarnAboutUseWrappedInTryCatch.has(workInProgress2) || didWarnAboutAsyncClientComponent.has(workInProgress2) || (didWarnAboutUseWrappedInTryCatch.add(workInProgress2), error$jscomp$0("`use` was called from inside a try/catch block. This is not allowed and can lead to unexpected behavior. To handle errors triggered by `use`, wrap your component in a error boundary.")));
    }
    ...
    function bailoutHooks(current2, workInProgress2, lanes) {
      ...
      workInProgress2.flags = (workInProgress2.mode & 16) !== 0 ? workInProgress2.flags & -201328645 : workInProgress2.flags & -2053;
    ...
    function useMemoCache(size) {
      ...
      if (updateQueue === undefined)
        ...
        updateQueue.length !== size && error$jscomp$0("Expected a constant size argument for each invocation of useMemoCache. The previous cache was allocated with size %s but size %s was requested.", updateQueue.length, size);
      memoCache.index++;
      return updateQueue;
    }
    ...
    function updateReducerImpl(hook, current2, reducer) {
      ...
      if (pendingQueue !== null) {
        ...
        current2.baseQueue !== baseQueue && error$jscomp$0("Internal error: Expected work-in-progress queue to be a clone. This is a bug in React.");
    ...
    function mountSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
      ...
      if (isHydrating) {
        ...
        didWarnUncachedGetSnapshot || nextSnapshot === getServerSnapshot() || (error$jscomp$0("The result of getServerSnapshot should be cached to avoid an infinite loop"), didWarnUncachedGetSnapshot = true);
      } else {
        nextSnapshot = getSnapshot();
        didWarnUncachedGetSnapshot || (getServerSnapshot = getSnapshot(), objectIs(nextSnapshot, getServerSnapshot) || (error$jscomp$0("The result of getSnapshot should be cached to avoid an infinite loop"), didWarnUncachedGetSnapshot = true));
        if (workInProgressRoot === null)
          throw Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");
        (workInProgressRootRenderLanes & (InputContinuousHydrationLane | InputContinuousLane | DefaultHydrationLane | DefaultLane)) !== 0 || pushStoreConsistencyCheck(fiber, getSnapshot, nextSnapshot);
      }
    ...
    function updateSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
      ...
      if (isHydrating$jscomp$0) {
        ...
        objectIs(getServerSnapshot, cachedSnapshot) || (error$jscomp$0("The result of getSnapshot should be cached to avoid an infinite loop"), didWarnUncachedGetSnapshot = true);
      }
      ...
      if (hook.getSnapshot !== getSnapshot || cachedSnapshot || workInProgressHook !== null && workInProgressHook.memoizedState.tag & HasEffect) {
        ...
        if (workInProgressRoot === null)
          throw Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");
        isHydrating$jscomp$0 || (renderLanes & (InputContinuousHydrationLane | InputContinuousLane | DefaultHydrationLane | DefaultLane)) !== 0 || pushStoreConsistencyCheck(fiber, getSnapshot, getServerSnapshot);
      }
    ...
    function forceStoreRerender(fiber) {
      ...
      root2 !== null && scheduleUpdateOnFiber(root2, fiber, SyncLane);
    }
    ...
    function runActionStateAction(actionQueue, node) {
      ...
      if (node.isTransition) {
        ...
        try {
          ...
          ReactSharedInternals.T = prevTransition, prevTransition === null && currentTransition._updatedFibers && (actionQueue = currentTransition._updatedFibers.size, currentTransition._updatedFibers.clear(), 10 < actionQueue && warn("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."));
        }
      } else
        try {
    ...
    function pushEffect(tag, create, inst, deps) {
      ...
      create === null ? (create = createFunctionComponentUpdateQueue(), currentlyRenderingFiber$1.updateQueue = create, create.lastEffect = tag.next = tag) : (inst = create.lastEffect, inst === null ? create.lastEffect = tag.next = tag : (deps = inst.next, inst.next = tag, tag.next = deps, create.lastEffect = tag));
      return tag;
    }
    ...
    function mountEffect(create, deps) {
      (currentlyRenderingFiber$1.mode & 16) !== 0 && (currentlyRenderingFiber$1.mode & 64) === 0 ? mountEffectImpl(142608384, Passive, create, deps) : mountEffectImpl(8390656, Passive, create, deps);
    }
    function mountLayoutEffect(create, deps) {
      var fiberFlags = 4194308;
      (currentlyRenderingFiber$1.mode & 16) !== 0 && (fiberFlags |= 67108864);
    ...
    function imperativeHandleEffect(create, ref) {
      ...
      if (ref !== null && ref !== undefined)
        return ref.hasOwnProperty("current") || error$jscomp$0("Expected useImperativeHandle() first argument to either be a ref callback or React.createRef() object. Instead received: %s.", "an object with keys {" + Object.keys(ref).join(", ") + "}"), create = create(), ref.current = create, function() {
          ref.current = null;
        };
    }
    function mountImperativeHandle(ref, create, deps) {
      typeof create !== "function" && error$jscomp$0("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.", create !== null ? typeof create : "null");
    ...
    function mountDeferredValueImpl(hook, value, initialValue) {
      if (initialValue === undefined || (renderLanes & DeferredLane) !== 0)
    ...
    function startTransition(fiber, queue, pendingState, finishedState, callback) {
      ...
      try {
        ...
        ReactDOMSharedInternals.p = previousPriority, ReactSharedInternals.T = prevTransition, prevTransition === null && currentTransition._updatedFibers && (fiber = currentTransition._updatedFibers.size, currentTransition._updatedFibers.clear(), 10 < fiber && warn("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."));
      }
    }
    ...
    function requestFormReset$1(formFiber) {
      ReactSharedInternals.T === null && error$jscomp$0("requestFormReset was called outside a transition or action. To fix, move to an action, or wrap with startTransition.");
      ...
      for (var provider = fiber.return;provider !== null; ) {
        switch (provider.tag) {
          ...
          case 3:
            ...
            seedKey !== null && seedKey !== undefined && root2 !== null && error$jscomp$0("The seed argument is not enabled outside experimental channels.");
    ...
    function dispatchReducerAction(fiber, queue, action, JSCompiler_OptimizeArgumentsArray_p0) {
      typeof JSCompiler_OptimizeArgumentsArray_p0 === "function" && error$jscomp$0("State updates from the useState() and useReducer() Hooks don't support the second callback argument. To execute a side effect after rendering, declare it in the component body with useEffect().");
    ...
    function dispatchSetState(fiber, queue, action, JSCompiler_OptimizeArgumentsArray_p1) {
      typeof JSCompiler_OptimizeArgumentsArray_p1 === "function" && error$jscomp$0("State updates from the useState() and useReducer() Hooks don't support the second callback argument. To execute a side effect after rendering, declare it in the component body with useEffect().");
      ...
      if (isRenderPhaseUpdate(fiber))
        ...
        action !== null && (scheduleUpdateOnFiber(action, fiber, JSCompiler_OptimizeArgumentsArray_p1), entangleTransitionUpdate(action, queue, JSCompiler_OptimizeArgumentsArray_p1));
      }
      markStateUpdateScheduled(fiber, JSCompiler_OptimizeArgumentsArray_p1);
    }
    function dispatchOptimisticSetState(fiber, throwIfDuringRender, queue, action) {
      ReactSharedInternals.T === null && currentEntangledLane === 0 && error$jscomp$0("An optimistic state update occurred outside a transition or action. To fix, move the update to an action, or wrap with startTransition.");
      action = {
        lane: SyncLane,
      ...
      if (isRenderPhaseUpdate(fiber)) {
        ...
        throwIfDuringRender = enqueueConcurrentHookUpdate(fiber, queue, action, SyncLane), throwIfDuringRender !== null && scheduleUpdateOnFiber(throwIfDuringRender, fiber, SyncLane);
    ...
    function initializeClassErrorUpdate(update, root2, fiber, errorInfo) {
      ...
      inst !== null && typeof inst.componentDidCatch === "function" && (update.callback = function() {
        ...
        typeof getDerivedStateFromError === "function" || (fiber.lanes & SyncLane) === 0 && error$jscomp$0("%s: Error boundaries should implement getDerivedStateFromError(). In that method, return a state update to display an error message or fallback UI.", getComponentNameFromFiber(fiber) || "Unknown");
      });
    }
    ...
    function updateSimpleMemoComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
      if (current2 !== null) {
        ...
        if (shallowEqual(prevProps, nextProps) && current2.ref === workInProgress2.ref && workInProgress2.type === current2.type)
          if (didReceiveUpdate = false, workInProgress2.pendingProps = nextProps = prevProps, (current2.lanes & renderLanes2) !== 0)
    ...
    function updateOffscreenComponent(current2, workInProgress2, renderLanes2) {
      ...
      if (nextProps.mode === "hidden" || nextIsDetached) {
        if ((workInProgress2.flags & 128) !== 0) {
          renderLanes2 = prevState !== null ? prevState.baseLanes | renderLanes2 : renderLanes2;
          if (current2 !== null) {
          ...
          return deferHiddenOffscreenComponent(current2, workInProgress2, renderLanes2);
        }
        if ((renderLanes2 & OffscreenLane) !== 0)
          ...
          return workInProgress2.lanes = workInProgress2.childLanes = OffscreenLane, deferHiddenOffscreenComponent(current2, workInProgress2, prevState !== null ? prevState.baseLanes | renderLanes2 : renderLanes2);
      } else
    ...
    function updateFunctionComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
      if (Component.prototype && typeof Component.prototype.render === "function") {
        ...
        didWarnAboutBadClass[componentName2] || (error$jscomp$0("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", componentName2, componentName2), didWarnAboutBadClass[componentName2] = true);
      }
      workInProgress2.mode & 8 && ReactStrictModeWarnings.recordLegacyContextWarning(workInProgress2, null);
      current2 === null && (validateFunctionComponentInDev(workInProgress2, workInProgress2.type), Component.contextTypes && error$jscomp$0("%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with React.useContext() instead.", getComponentNameFromType(Component) || "Unknown"));
      prepareToReadContext(workInProgress2, renderLanes2);
      markComponentRenderStarted(workInProgress2);
    ...
    function updateClassComponent(current$jscomp$0, workInProgress2, Component, nextProps, renderLanes2) {
      ...
      if (workInProgress2.stateNode === null) {
        ...
        typeof Component.getDerivedStateFromProps === "function" && state === null && (state = getComponentNameFromType(Component) || "Component", didWarnAboutUninitializedState.has(state) || (didWarnAboutUninitializedState.add(state), error$jscomp$0("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", state, _instance.state === null ? "null" : "undefined", state)));
        ...
        _instance.render || (Component.prototype && typeof Component.prototype.render === "function" ? error$jscomp$0("No `render` method found on the %s instance: did you accidentally return an object from the constructor?", state) : error$jscomp$0("No `render` method found on the %s instance: you may have forgotten to define `render`.", state));
        ...
        typeof _instance.componentShouldUpdate === "function" && error$jscomp$0("%s has a method called componentShouldUpdate(). Did you mean shouldComponentUpdate()? The name is phrased as a question because the function is expected to return a value.", state);
        Component.prototype && Component.prototype.isPureReactComponent && typeof _instance.shouldComponentUpdate !== "undefined" && error$jscomp$0("%s has a method called shouldComponentUpdate(). shouldComponentUpdate should not be used when extending React.PureComponent. Please extend React.Component if shouldComponentUpdate is used.", getComponentNameFromType(Component) || "A pure component");
        typeof _instance.componentDidUnmount === "function" && error$jscomp$0("%s has a method called componentDidUnmount(). But there is no such lifecycle method. Did you mean componentWillUnmount()?", state);
        typeof _instance.componentDidReceiveProps === "function" && error$jscomp$0("%s has a method called componentDidReceiveProps(). But there is no such lifecycle method. If you meant to update the state in response to changing props, use componentWillReceiveProps(). If you meant to fetch data or run side-effects or mutations after React has updated the UI, use componentDidUpdate().", state);
        typeof _instance.componentWillRecieveProps === "function" && error$jscomp$0("%s has a method called componentWillRecieveProps(). Did you mean componentWillReceiveProps()?", state);
        typeof _instance.UNSAFE_componentWillRecieveProps === "function" && error$jscomp$0("%s has a method called UNSAFE_componentWillRecieveProps(). Did you mean UNSAFE_componentWillReceiveProps()?", state);
        lane = _instance.props !== nextProps;
        _instance.props !== undefined && lane && error$jscomp$0("When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.", state);
        ...
        typeof _instance.getSnapshotBeforeUpdate !== "function" || typeof _instance.componentDidUpdate === "function" || didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.has(Component) || (didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate.add(Component), error$jscomp$0("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.", getComponentNameFromType(Component)));
        typeof _instance.getDerivedStateFromProps === "function" && error$jscomp$0("%s: getDerivedStateFromProps() is defined as an instance method and will be ignored. Instead, declare it as a static method.", state);
        typeof _instance.getDerivedStateFromError === "function" && error$jscomp$0("%s: getDerivedStateFromError() is defined as an instance method and will be ignored. Instead, declare it as a static method.", state);
        typeof Component.getSnapshotBeforeUpdate === "function" && error$jscomp$0("%s: getSnapshotBeforeUpdate() is defined as a static method and will be ignored. Instead, declare it as an instance method.", state);
        (lane = _instance.state) && (typeof lane !== "object" || isArrayImpl(lane)) && error$jscomp$0("%s.state: must be set to an object or null", state);
        typeof _instance.getChildContext === "function" && typeof Component.childContextTypes !== "object" && error$jscomp$0("%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().", state);
        _instance = workInProgress2.stateNode;
        ...
        typeof Component.getDerivedStateFromProps === "function" || typeof _instance.getSnapshotBeforeUpdate === "function" || typeof _instance.UNSAFE_componentWillMount !== "function" && typeof _instance.componentWillMount !== "function" || (state = _instance.state, typeof _instance.componentWillMount === "function" && _instance.componentWillMount(), typeof _instance.UNSAFE_componentWillMount === "function" && _instance.UNSAFE_componentWillMount(), state !== _instance.state && (error$jscomp$0("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", getComponentNameFromFiber(workInProgress2) || "Component"), classComponentUpdater.enqueueReplaceState(_instance, _instance.state, null)), processUpdateQueue(workInProgress2, nextProps, _instance, renderLanes2), suspendIfUpdateReadFromEntangledAsyncAction(), _instance.state = workInProgress2.memoizedState);
        typeof _instance.componentDidMount === "function" && (workInProgress2.flags |= 4194308);
        (workInProgress2.mode & 16) !== 0 && (workInProgress2.flags |= 67108864);
        _instance = true;
      ...
      _instance && renderLanes2.props !== nextProps && (didWarnAboutReassigningProps || error$jscomp$0("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", getComponentNameFromFiber(workInProgress2) || "a component"), didWarnAboutReassigningProps = true);
    ...
    function validateFunctionComponentInDev(workInProgress2, Component) {
      ...
      typeof Component.getDerivedStateFromProps === "function" && (workInProgress2 = getComponentNameFromType(Component) || "Unknown", didWarnAboutGetDerivedStateOnFunctionComponent[workInProgress2] || (error$jscomp$0("%s: Function components do not support getDerivedStateFromProps.", workInProgress2), didWarnAboutGetDerivedStateOnFunctionComponent[workInProgress2] = true));
      typeof Component.contextType === "object" && Component.contextType !== null && (Component = getComponentNameFromType(Component) || "Unknown", didWarnAboutContextTypeOnFunctionComponent[Component] || (error$jscomp$0("%s: Function components do not support contextType.", Component), didWarnAboutContextTypeOnFunctionComponent[Component] = true));
    }
    ...
    function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
      ...
      var JSCompiler_object_inline_stack_2331 = workInProgress2.pendingProps;
      shouldSuspendImpl(workInProgress2) && (workInProgress2.flags |= 128);
      var JSCompiler_object_inline_componentStack_2332 = false;
      var didSuspend = (workInProgress2.flags & 128) !== 0;
      (JSCompiler_object_inline_digest_2330 = didSuspend) || (JSCompiler_object_inline_digest_2330 = current2 !== null && current2.memoizedState === null ? false : (suspenseStackCursor.current & ForceSuspenseFallback) !== 0);
      JSCompiler_object_inline_digest_2330 && (JSCompiler_object_inline_componentStack_2332 = true, workInProgress2.flags &= -129);
      JSCompiler_object_inline_digest_2330 = (workInProgress2.flags & 32) !== 0;
      workInProgress2.flags &= -33;
      if (current2 === null) {
        if (isHydrating) {
          JSCompiler_object_inline_componentStack_2332 ? pushPrimaryTreeSuspenseHandler(workInProgress2) : reuseSuspenseHandlerOnStack(workInProgress2);
          if (isHydrating) {
            ...
            JSCompiler_temp && (warnNonHydratedInstance(workInProgress2, JSCompiler_object_inline_message_2329), throwOnHydrationMismatch(workInProgress2));
          }
          JSCompiler_object_inline_message_2329 = workInProgress2.memoizedState;
          if (JSCompiler_object_inline_message_2329 !== null && (JSCompiler_object_inline_message_2329 = JSCompiler_object_inline_message_2329.dehydrated, JSCompiler_object_inline_message_2329 !== null))
            return JSCompiler_object_inline_message_2329.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress2.lanes = DefaultHydrationLane : workInProgress2.lanes = OffscreenLane, null;
          popSuspenseHandler(workInProgress2);
        }
        JSCompiler_object_inline_message_2329 = JSCompiler_object_inline_stack_2331.children;
        JSCompiler_object_inline_stack_2331 = JSCompiler_object_inline_stack_2331.fallback;
        if (JSCompiler_object_inline_componentStack_2332)
          return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2332 = workInProgress2.mode, JSCompiler_object_inline_message_2329 = mountWorkInProgressOffscreenFiber({
            mode: "hidden",
            children: JSCompiler_object_inline_message_2329
          }, JSCompiler_object_inline_componentStack_2332), JSCompiler_object_inline_stack_2331 = createFiberFromFragment(JSCompiler_object_inline_stack_2331, JSCompiler_object_inline_componentStack_2332, renderLanes2, null), JSCompiler_object_inline_message_2329.return = workInProgress2, JSCompiler_object_inline_stack_2331.return = workInProgress2, JSCompiler_object_inline_message_2329.sibling = JSCompiler_object_inline_stack_2331, workInProgress2.child = JSCompiler_object_inline_message_2329, JSCompiler_object_inline_componentStack_2332 = workInProgress2.child, JSCompiler_object_inline_componentStack_2332.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_componentStack_2332.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2330, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2331;
        pushPrimaryTreeSuspenseHandler(workInProgress2);
        return mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_message_2329);
      }
      var prevState = current2.memoizedState;
      if (prevState !== null && (JSCompiler_object_inline_message_2329 = prevState.dehydrated, JSCompiler_object_inline_message_2329 !== null)) {
        if (didSuspend)
          workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2)) : workInProgress2.memoizedState !== null ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2332 = JSCompiler_object_inline_stack_2331.fallback, JSCompiler_object_inline_message_2329 = workInProgress2.mode, JSCompiler_object_inline_stack_2331 = mountWorkInProgressOffscreenFiber({
            mode: "visible",
            children: JSCompiler_object_inline_stack_2331.children
          }, JSCompiler_object_inline_message_2329), JSCompiler_object_inline_componentStack_2332 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2332, JSCompiler_object_inline_message_2329, renderLanes2, null), JSCompiler_object_inline_componentStack_2332.flags |= 2, JSCompiler_object_inline_stack_2331.return = workInProgress2, JSCompiler_object_inline_componentStack_2332.return = workInProgress2, JSCompiler_object_inline_stack_2331.sibling = JSCompiler_object_inline_componentStack_2332, workInProgress2.child = JSCompiler_object_inline_stack_2331, reconcileChildFibers(workInProgress2, current2.child, null, renderLanes2), JSCompiler_object_inline_stack_2331 = workInProgress2.child, JSCompiler_object_inline_stack_2331.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2331.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2330, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_componentStack_2332);
        else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && error$jscomp$0("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_message_2329.data === SUSPENSE_FALLBACK_START_DATA) {
          JSCompiler_object_inline_digest_2330 = JSCompiler_object_inline_message_2329.nextSibling && JSCompiler_object_inline_message_2329.nextSibling.dataset;
          ...
          JSCompiler_object_inline_message_2329 = JSCompiler_object_inline_message_2329 ? Error(JSCompiler_object_inline_message_2329) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
          JSCompiler_object_inline_message_2329.stack = JSCompiler_object_inline_stack_2331 || "";
          JSCompiler_object_inline_message_2329.digest = JSCompiler_object_inline_digest_2330;
          JSCompiler_object_inline_digest_2330 = JSCompiler_object_inline_componentStack_2332 === undefined ? null : JSCompiler_object_inline_componentStack_2332;
          typeof JSCompiler_object_inline_digest_2330 === "string" && CapturedStacks.set(JSCompiler_object_inline_message_2329, JSCompiler_object_inline_digest_2330);
          queueHydrationError({
        ...
        } else if (JSCompiler_object_inline_digest_2330 = (renderLanes2 & current2.childLanes) !== 0, didReceiveUpdate || JSCompiler_object_inline_digest_2330) {
          JSCompiler_object_inline_digest_2330 = workInProgressRoot;
          if (JSCompiler_object_inline_digest_2330 !== null) {
            JSCompiler_object_inline_stack_2331 = renderLanes2 & -renderLanes2;
            if ((JSCompiler_object_inline_stack_2331 & SyncUpdateLanes) !== 0)
              ...
              switch (JSCompiler_object_inline_stack_2331) {
                case SyncLane:
                  ...
                  break;
                case InputContinuousLane:
                  JSCompiler_object_inline_stack_2331 = InputContinuousHydrationLane;
                  break;
                case DefaultLane:
            ...
            JSCompiler_object_inline_stack_2331 = (JSCompiler_object_inline_stack_2331 & (JSCompiler_object_inline_digest_2330.suspendedLanes | renderLanes2)) !== 0 ? 0 : JSCompiler_object_inline_stack_2331;
            if (JSCompiler_object_inline_stack_2331 !== 0 && JSCompiler_object_inline_stack_2331 !== prevState.retryLane)
              throw prevState.retryLane = JSCompiler_object_inline_stack_2331, enqueueConcurrentRenderForLane(current2, JSCompiler_object_inline_stack_2331), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2330, current2, JSCompiler_object_inline_stack_2331), SelectiveHydrationException;
          }
          JSCompiler_object_inline_message_2329.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
          workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2);
        } else
          JSCompiler_object_inline_message_2329.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 128, workInProgress2.child = current2.child, workInProgress2 = retryDehydratedSuspenseBoundary.bind(null, current2), JSCompiler_object_inline_message_2329._reactRetry = workInProgress2, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2329.nextSibling), hydrationParentFiber = workInProgress2, isHydrating = true, hydrationErrors = null, didSuspendOrErrorDEV = false, hydrationDiffRootDEV = null, rootOrSingletonContext = false, current2 !== null && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current2.id, treeContextOverflow = current2.overflow, treeContextProvider = workInProgress2), workInProgress2 = mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_stack_2331.children), workInProgress2.flags |= 4096);
        return workInProgress2;
      }
      if (JSCompiler_object_inline_componentStack_2332)
        return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2332 = JSCompiler_object_inline_stack_2331.fallback, JSCompiler_object_inline_message_2329 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2331 = createWorkInProgress(JSCompiler_temp, {
          mode: "hidden",
          children: JSCompiler_object_inline_stack_2331.children
        }), JSCompiler_object_inline_stack_2331.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, instance !== null ? JSCompiler_object_inline_componentStack_2332 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2332) : (JSCompiler_object_inline_componentStack_2332 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2332, JSCompiler_object_inline_message_2329, renderLanes2, null), JSCompiler_object_inline_componentStack_2332.flags |= 2), JSCompiler_object_inline_componentStack_2332.return = workInProgress2, JSCompiler_object_inline_stack_2331.return = workInProgress2, JSCompiler_object_inline_stack_2331.sibling = JSCompiler_object_inline_componentStack_2332, workInProgress2.child = JSCompiler_object_inline_stack_2331, JSCompiler_object_inline_stack_2331 = JSCompiler_object_inline_componentStack_2332, JSCompiler_object_inline_componentStack_2332 = workInProgress2.child, JSCompiler_object_inline_message_2329 = current2.child.memoizedState, JSCompiler_object_inline_message_2329 === null ? JSCompiler_object_inline_message_2329 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_message_2329.cachePool, JSCompiler_temp !== null ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2329 = {
          baseLanes: JSCompiler_object_inline_message_2329.baseLanes | renderLanes2,
          cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_componentStack_2332.memoizedState = JSCompiler_object_inline_message_2329, JSCompiler_object_inline_componentStack_2332.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2330, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2331;
      pushPrimaryTreeSuspenseHandler(workInProgress2);
      ...
      current2 !== null && (JSCompiler_object_inline_digest_2330 = workInProgress2.deletions, JSCompiler_object_inline_digest_2330 === null ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2330.push(current2));
    ...
    function validateSuspenseListNestedChild(childSlot, index) {
      ...
      return isAnArray || childSlot ? (isAnArray = isAnArray ? "array" : "iterable", error$jscomp$0("A nested %s was passed to row #%s in <SuspenseList />. Wrap it in an additional SuspenseList to configure its revealOrder: <SuspenseList revealOrder=...> ... <SuspenseList revealOrder=...>{%s}</SuspenseList> ... </SuspenseList>", isAnArray, index, isAnArray), false) : true;
    }
    ...
    function updateSuspenseListComponent(current2, workInProgress2, renderLanes2) {
      ...
      if (revealOrder !== undefined && revealOrder !== "forwards" && revealOrder !== "backwards" && revealOrder !== "together" && !didWarnAboutRevealOrder[revealOrder])
        if (didWarnAboutRevealOrder[revealOrder] = true, typeof revealOrder === "string")
          ...
          error$jscomp$0('%s is not a supported value for revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?', revealOrder);
      tailMode === undefined || didWarnAboutTailOptions[tailMode] || (tailMode !== "collapsed" && tailMode !== "hidden" ? (didWarnAboutTailOptions[tailMode] = true, error$jscomp$0('"%s" is not a supported value for tail on <SuspenseList />. Did you mean "collapsed" or "hidden"?', tailMode)) : revealOrder !== "forwards" && revealOrder !== "backwards" && (didWarnAboutTailOptions[tailMode] = true, error$jscomp$0('<SuspenseList tail="%s" /> is only valid if revealOrder is "forwards" or "backwards". Did you mean to specify revealOrder="forwards"?', tailMode)));
      a:
        if ((revealOrder === "forwards" || revealOrder === "backwards") && nextProps !== undefined && nextProps !== null && nextProps !== false)
          if (isArrayImpl(nextProps))
            ...
            error$jscomp$0('A single row was passed to a <SuspenseList revealOrder="%s" />. This is not useful since it needs multiple rows. Did you mean to pass multiple children or an array?', revealOrder);
      reconcileChildren(current2, workInProgress2, nextProps, renderLanes2);
    ...
    function beginWork(current2, workInProgress2, renderLanes2) {
      ...
      if (current2 !== null)
        if (current2.memoizedProps !== workInProgress2.pendingProps || workInProgress2.type !== current2.type)
          ...
          if ((current2.lanes & renderLanes2) === 0 && (workInProgress2.flags & 128) === 0)
      ...
      switch (workInProgress2.tag) {
        ...
        case 12:
          return workInProgress2.flags |= 4, returnFiber = workInProgress2.stateNode, returnFiber.effectDuration = 0, returnFiber.passiveEffectDuration = 0, reconcileChildren(current2, workInProgress2, workInProgress2.pendingProps.children, renderLanes2), workInProgress2.child;
        case 10:
          a: {
            ...
            "value" in prevSibling || hasWarnedAboutUsingNoValuePropOnContextProvider || (hasWarnedAboutUsingNoValuePropOnContextProvider = true, error$jscomp$0("The `value` prop is required for the `<Context.Provider>`. Did you misspell it or forget to pass it?"));
            ...
            if (nextProps !== null)
              if (objectIs(nextProps.value, nextState)) {
                ...
                propagateContextChange(workInProgress2, returnFiber, renderLanes2);
            reconcileChildren(current2, workInProgress2, prevSibling.children, renderLanes2);
            workInProgress2 = workInProgress2.child;
          }
          return workInProgress2;
        case 9:
          return prevSibling = workInProgress2.type._context, returnFiber = workInProgress2.pendingProps.children, typeof returnFiber !== "function" && error$jscomp$0("A context consumer was rendered with multiple children, or a child that isn't a function. A context consumer expects a single child that is a function. If you did pass a function, make sure there is no trailing or leading whitespace around it."), prepareToReadContext(workInProgress2, renderLanes2), prevSibling = readContext(prevSibling), markComponentRenderStarted(workInProgress2), returnFiber = callComponentInDEV(returnFiber, prevSibling, undefined), markComponentRenderStopped(), workInProgress2.flags |= 1, reconcileChildren(current2, workInProgress2, returnFiber, renderLanes2), workInProgress2.child;
        case 14:
    ...
    function pushProvider(providerFiber, context, nextValue) {
      ...
      context._currentRenderer !== undefined && context._currentRenderer !== null && context._currentRenderer !== rendererSigil && error$jscomp$0("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported.");
    ...
    function prepareToReadContext(workInProgress2, renderLanes2) {
      ...
      workInProgress2 !== null && workInProgress2.firstContext !== null && ((workInProgress2.lanes & renderLanes2) !== 0 && (didReceiveUpdate = true), workInProgress2.firstContext = null);
    }
    ...
    function readContextDuringReconciliation(consumer, context, renderLanes2) {
      currentlyRenderingFiber === null && prepareToReadContext(consumer, renderLanes2);
    ...
    function applyDerivedStateFromProps(workInProgress2, ctor, getDerivedStateFromProps, nextProps) {
      ...
      partialState === undefined && (ctor = getComponentNameFromType(ctor) || "Component", didWarnAboutUndefinedDerivedState.has(ctor) || (didWarnAboutUndefinedDerivedState.add(ctor), error$jscomp$0("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.", ctor)));
    ...
    function checkShouldComponentUpdate(workInProgress2, ctor, oldProps, newProps, oldState, newState, nextContext) {
      ...
      if (typeof instance.shouldComponentUpdate === "function") {
        ...
        oldProps === undefined && error$jscomp$0("%s.shouldComponentUpdate(): Returned undefined instead of a boolean value. Make sure to return true or false.", getComponentNameFromType(ctor) || "Component");
        return oldProps;
      }
    ...
    function callComponentWillReceiveProps(workInProgress2, instance, newProps, nextContext) {
      ...
      instance.state !== oldState && (workInProgress2 = getComponentNameFromFiber(workInProgress2) || "Component", didWarnAboutStateAssignmentForComponent.has(workInProgress2) || (didWarnAboutStateAssignmentForComponent.add(workInProgress2), error$jscomp$0("%s.componentWillReceiveProps(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", workInProgress2)), classComponentUpdater.enqueueReplaceState(instance, instance.state, null));
    }
    ...
    function shouldProfile(current2) {
      return (current2.mode & 2) !== 0 && (executionContext & CommitContext) !== NoContext;
    }
      ...
      try {
        ...
        if (ref !== null) {
          ...
          if (typeof ref === "function")
            ...
            typeof ref === "string" ? error$jscomp$0("String refs are no longer supported.") : ref.hasOwnProperty("current") || error$jscomp$0("Unexpected ref object provided for %s. Use either a ref-setter function or React.createRef().", getComponentNameFromFiber(current2)), ref.current = instanceToUse;
        }
      } catch (error$11) {
        captureCommitPhaseError(current2, nearestMountedAncestor, error$11);
      }
    }
    ...
    function commitBeforeMutationEffectsOnFiber(finishedWork) {
      ...
      switch (finishedWork.tag) {
        ...
        case 15:
          break;
        case 1:
          if ((flags & 1024) !== 0 && current2 !== null) {
            flags = current2.memoizedProps;
            var prevState = current2.memoizedState;
            current2 = finishedWork.stateNode;
            finishedWork.type.defaultProps || "ref" in finishedWork.memoizedProps || didWarnAboutReassigningProps || (current2.props !== finishedWork.memoizedProps && error$jscomp$0("Expected %s props to match memoized props before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.", getComponentNameFromFiber(finishedWork) || "instance"), current2.state !== finishedWork.memoizedState && error$jscomp$0("Expected %s state to match memoized state before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.state`. Please file an issue.", getComponentNameFromFiber(finishedWork) || "instance"));
            flags = current2.getSnapshotBeforeUpdate(resolveClassComponentProps(finishedWork.type, flags), prevState);
            prevState = didWarnAboutUndefinedSnapshotBeforeUpdate;
            flags !== undefined || prevState.has(finishedWork.type) || (prevState.add(finishedWork.type), error$jscomp$0("%s.getSnapshotBeforeUpdate(): A snapshot value (or null) must be returned. You have returned undefined.", getComponentNameFromFiber(finishedWork)));
        ...
        case 3:
          if ((flags & 1024) !== 0)
            a:
              if (finishedWork = finishedWork.stateNode.containerInfo, current2 = finishedWork.nodeType, current2 === 9)
      ...
      if (updateQueue !== null) {
        ...
        do {
          if ((effect.tag & flags) === flags) {
            ...
            destroy !== undefined && (inst.destroy = undefined, (flags & Passive) !== NoFlags ? injectedProfilingHooks !== null && typeof injectedProfilingHooks.markComponentPassiveEffectUnmountStarted === "function" && injectedProfilingHooks.markComponentPassiveEffectUnmountStarted(finishedWork) : (flags & Layout) !== NoFlags && markComponentLayoutEffectUnmountStarted(finishedWork), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = true), safelyCallDestroy(finishedWork, nearestMountedAncestor, destroy), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = false), (flags & Passive) !== NoFlags ? injectedProfilingHooks !== null && typeof injectedProfilingHooks.markComponentPassiveEffectUnmountStopped === "function" && injectedProfilingHooks.markComponentPassiveEffectUnmountStopped() : (flags & Layout) !== NoFlags && markComponentLayoutEffectUnmountStopped());
          }
          effect = effect.next;
      ...
      if (updateQueue !== null) {
        ...
        do {
          if ((effect.tag & flags) === flags) {
            ...
            (flags & Passive) !== NoFlags ? injectedProfilingHooks !== null && typeof injectedProfilingHooks.markComponentPassiveEffectMountStopped === "function" && injectedProfilingHooks.markComponentPassiveEffectMountStopped() : (flags & Layout) !== NoFlags && injectedProfilingHooks !== null && typeof injectedProfilingHooks.markComponentLayoutEffectMountStopped === "function" && injectedProfilingHooks.markComponentLayoutEffectMountStopped();
            create !== undefined && typeof create !== "function" && (inst = (effect.tag & Layout) !== 0 ? "useLayoutEffect" : (effect.tag & Insertion) !== 0 ? "useInsertionEffect" : "useEffect", error$jscomp$0("%s must not return anything besides a function, which is used for clean-up.%s", inst, create === null ? " You returned null. If your effect does not require clean up, return undefined (or nothing)." : typeof create.then === "function" ? "\n\nIt looks like you wrote " + inst + "(async () => ...) or returned a Promise. Instead, write the async function inside your effect and call it immediately:\n\n" + inst + "(() => {\n  async function fetchData() {\n    // You can await here\n    const response = await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://react.dev/link/hooks-data-fetching" : " You returned: " + create));
          }
          effect = effect.next;
        } while (effect !== updateQueue);
      }
    ...
    function commitProfilerUpdate(finishedWork, current2) {
      if (executionContext & CommitContext)
        try {
          ...
          typeof onRender === "function" && onRender(finishedWork.memoizedProps.id, current2, finishedWork.actualDuration, finishedWork.treeBaseDuration, finishedWork.actualStartTime, _finishedWork$memoize2);
          typeof onCommit === "function" && onCommit(finishedWork.memoizedProps.id, current2, effectDuration, _finishedWork$memoize2);
    ...
    function commitLayoutEffectOnFiber(finishedRoot, current2, finishedWork, committedLanes) {
      ...
      switch (finishedWork.tag) {
        ...
        case 1:
          ...
          if (flags & 4)
            if (finishedRoot = finishedWork.stateNode, current2 === null)
              ...
              committedLanes = resolveClassComponentProps(finishedWork.type, current2.memoizedProps);
              var prevState = current2.memoizedState;
        ...
        case 5:
          recursivelyTraverseLayoutEffects(finishedRoot, finishedWork, committedLanes);
          current2 === null && flags & 4 && commitHostComponentMount(finishedWork);
          flags & 512 && safelyAttachRef(finishedWork, finishedWork.return);
          break;
        case 12:
          recursivelyTraverseLayoutEffects(finishedRoot, finishedWork, committedLanes);
        ...
        case 13:
          ...
          break;
        case 22:
          prevState = finishedWork.memoizedState !== null || offscreenSubtreeIsHidden;
          if (!prevState) {
            ...
            (offscreenSubtreeWasHidden = current2) && !prevOffscreenSubtreeWasHidden ? recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, (finishedWork.subtreeFlags & 8772) !== 0) : recursivelyTraverseLayoutEffects(finishedRoot, finishedWork, committedLanes);
      ...
      switch (deletedFiber.tag) {
        ...
        case 15:
          if (!offscreenSubtreeWasHidden && (prevHostParent = deletedFiber.updateQueue, prevHostParent !== null && (prevHostParent = prevHostParent.lastEffect, prevHostParent !== null))) {
            ...
            do {
              var { tag, inst } = prevHostParentIsContainer, destroy = inst.destroy;
              destroy !== undefined && ((tag & Insertion) !== NoFlags ? (inst.destroy = undefined, safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy)) : (tag & Layout) !== NoFlags && (markComponentLayoutEffectUnmountStarted(deletedFiber), shouldProfile(deletedFiber) ? (startLayoutEffectTimer(), inst.destroy = undefined, safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy), recordLayoutEffectDuration(deletedFiber)) : (inst.destroy = undefined, safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy)), markComponentLayoutEffectUnmountStopped()));
          ...
          break;
        case 1:
          if (!offscreenSubtreeWasHidden && (safelyDetachRef(deletedFiber, nearestMountedAncestor), prevHostParent = deletedFiber.stateNode, typeof prevHostParent.componentWillUnmount === "function"))
            try {
    ...
    function commitMutationEffects(root2, finishedWork, committedLanes) {
      ...
      runWithFiberInDEV(finishedWork, commitMutationEffectsOnFiber, finishedWork, root2, committedLanes);
    ...
    function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber, lanes) {
      ...
      if (parentFiber.subtreeFlags & 13878)
        for (parentFiber = parentFiber.child;parentFiber !== null; )
          runWithFiberInDEV(parentFiber, commitMutationEffectsOnFiber, parentFiber, root$jscomp$0, lanes), parentFiber = parentFiber.sibling;
    }
    function commitMutationEffectsOnFiber(finishedWork, root2, lanes) {
      ...
      switch (finishedWork.tag) {
        ...
        case 1:
          recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
          commitReconciliationEffects(finishedWork);
          flags & 512 && current2 !== null && safelyDetachRef(current2, current2.return);
        ...
        case 26:
          ...
          if (flags & 4) {
            if (root2 = current2 !== null ? current2.memoizedState : null, flags = finishedWork.memoizedState, current2 === null)
                      ...
                      switch (flags) {
                        case "title":
                          ...
                          if (!lanes || lanes[internalHoistableMarker] || lanes[internalInstanceKey] || lanes.namespaceURI === SVG_NAMESPACE || lanes.hasAttribute("itemprop"))
                            lanes = root2.createElement(flags), root2.head.insertBefore(lanes, root2.querySelector("head > title"));
                          ...
                          break a;
                        case "link":
                          if (hoistableRoot = getHydratableHoistableCache("link", "href", root2).get(flags + (current2.href || ""))) {
                            for (var i = 0;i < hoistableRoot.length; i++)
                              if (lanes = hoistableRoot[i], lanes.getAttribute("href") === (current2.href == null ? null : current2.href) && lanes.getAttribute("rel") === (current2.rel == null ? null : current2.rel) && lanes.getAttribute("title") === (current2.title == null ? null : current2.title) && lanes.getAttribute("crossorigin") === (current2.crossOrigin == null ? null : current2.crossOrigin)) {
                          ...
                          break;
                        case "meta":
                          if (hoistableRoot = getHydratableHoistableCache("meta", "content", root2).get(flags + (current2.content || ""))) {
                            for (i = 0;i < hoistableRoot.length; i++)
                              if (lanes = hoistableRoot[i], checkAttributeStringCoercion(current2.content, "content"), lanes.getAttribute("content") === (current2.content == null ? null : "" + current2.content) && lanes.getAttribute("name") === (current2.name == null ? null : current2.name) && lanes.getAttribute("property") === (current2.property == null ? null : current2.property) && lanes.getAttribute("http-equiv") === (current2.httpEquiv == null ? null : current2.httpEquiv) && lanes.getAttribute("charset") === (current2.charSet == null ? null : current2.charSet)) {
                                hoistableRoot.splice(i, 1);
                                break b;
                              }
                          }
              ...
              root2 === null ? current2.stateNode !== null && (current2 = current2.stateNode, current2.parentNode.removeChild(current2)) : root2.count--, flags === null ? mountHoistable(hoistableRoot, finishedWork.type, finishedWork.stateNode) : acquireResource(hoistableRoot, flags, finishedWork.memoizedProps);
            else if (flags === null && finishedWork.stateNode !== null)
              try {
                var { stateNode: domElement, memoizedProps: newProps } = finishedWork;
                updateProperties(domElement, finishedWork.type, current2.memoizedProps, newProps);
        ...
        case 27:
          if (flags & 4 && finishedWork.alternate === null) {
            ...
            for (var node = hoistableRoot.firstChild;node; ) {
              var { nextSibling: nextNode, nodeName } = node;
              node[internalHoistableMarker] || nodeName === "HEAD" || nodeName === "BODY" || nodeName === "SCRIPT" || nodeName === "STYLE" || nodeName === "LINK" && node.rel.toLowerCase() === "stylesheet" || hoistableRoot.removeChild(node);
              node = nextNode;
            }
        ...
        case 5:
          ...
          if (flags & 4 && (root2 = finishedWork.stateNode, root2 != null)) {
            lanes = finishedWork.memoizedProps;
            current2 = current2 !== null ? current2.memoizedProps : lanes;
          ...
          flags & 1024 && (needsFormReset = true, finishedWork.type !== "form" && error$jscomp$0("Unexpected host component type. Expected a form. This is a bug in React."));
          break;
        case 6:
          recursivelyTraverseMutationEffects(root2, finishedWork, lanes);
          commitReconciliationEffects(finishedWork);
        ...
        case 22:
          flags & 512 && current2 !== null && safelyDetachRef(current2, current2.return);
          domElement = finishedWork.memoizedState !== null;
          newProps = current2 !== null && current2.memoizedState !== null;
          var prevOffscreenSubtreeIsHidden = offscreenSubtreeIsHidden, prevOffscreenSubtreeWasHidden = offscreenSubtreeWasHidden;
              ...
              for (current2 = null, root2 = finishedWork;; ) {
                if (root2.tag === 5 || root2.tag === 26 || root2.tag === 27) {
                  if (current2 === null) {
                    current2 = root2;
                    try {
                      hoistableRoot = root2.stateNode, domElement ? (i = hoistableRoot.style, typeof i.setProperty === "function" ? i.setProperty("display", "none", "important") : i.display = "none") : (node = root2.stateNode, nextNode = root2.memoizedProps[STYLE], nodeName = nextNode !== undefined && nextNode !== null && nextNode.hasOwnProperty("display") ? nextNode.display : null, node.style.display = nodeName == null || typeof nodeName === "boolean" ? "" : ("" + nodeName).trim());
                    } catch (error$26) {
    ...
    function commitLayoutEffects(finishedWork, root2, committedLanes) {
      inProgressLanes = committedLanes;
      inProgressRoot = root2;
      runWithFiberInDEV(finishedWork, commitLayoutEffectOnFiber, root2, finishedWork.alternate, finishedWork, committedLanes);
      inProgressRoot = inProgressLanes = null;
    }
    function recursivelyTraverseLayoutEffects(root2, parentFiber, lanes) {
      if (parentFiber.subtreeFlags & 8772)
        for (parentFiber = parentFiber.child;parentFiber !== null; )
          runWithFiberInDEV(parentFiber, commitLayoutEffectOnFiber, root2, parentFiber.alternate, parentFiber, lanes), parentFiber = parentFiber.sibling;
    }
    ...
    function reappearLayoutEffects(finishedRoot, current2, finishedWork, includeWorkInProgressEffects) {
      ...
      switch (finishedWork.tag) {
        ...
        case 1:
          ...
          var updateQueue = finishedWork.updateQueue;
          if (updateQueue !== null && (current2 = updateQueue.shared.hiddenCallbacks, current2 !== null))
        ...
        case 5:
          recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, includeWorkInProgressEffects);
          includeWorkInProgressEffects && current2 === null && flags & 4 && commitHostComponentMount(finishedWork);
          safelyAttachRef(finishedWork, finishedWork.return);
          break;
        case 12:
          recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, includeWorkInProgressEffects);
    ...
    function recursivelyTraverseReappearLayoutEffects(finishedRoot, parentFiber, includeWorkInProgressEffects) {
      ...
      for (parentFiber = parentFiber.child;parentFiber !== null; )
        runWithFiberInDEV(parentFiber, reappearLayoutEffects, finishedRoot, parentFiber.alternate, parentFiber, includeWorkInProgressEffects), parentFiber = parentFiber.sibling;
    }
    ...
    function recursivelyTraversePassiveMountEffects(root2, parentFiber, committedLanes, committedTransitions) {
      if (parentFiber.subtreeFlags & 10256)
        for (parentFiber = parentFiber.child;parentFiber !== null; )
          runWithFiberInDEV(parentFiber, commitPassiveMountOnFiber, root2, parentFiber, committedLanes, committedTransitions), parentFiber = parentFiber.sibling;
    }
    function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions) {
      ...
      switch (finishedWork.tag) {
        ...
        case 3:
          recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions);
          flags & 2048 && (finishedRoot = null, finishedWork.alternate !== null && (finishedRoot = finishedWork.alternate.memoizedState.cache), finishedWork = finishedWork.memoizedState.cache, finishedWork !== finishedRoot && (retainCache(finishedWork), finishedRoot != null && releaseCache(finishedRoot)));
          break;
        case 23:
          break;
        case 22:
          var _instance3 = finishedWork.stateNode;
          finishedWork.memoizedState !== null ? _instance3._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions) : recursivelyTraverseAtomicPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions) : _instance3._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions) : (_instance3._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, (finishedWork.subtreeFlags & 10256) !== 0));
    ...
    function recursivelyTraverseReconnectPassiveEffects(finishedRoot, parentFiber, committedLanes, committedTransitions, includeWorkInProgressEffects) {
      ...
      for (parentFiber = parentFiber.child;parentFiber !== null; )
        runWithFiberInDEV(parentFiber, reconnectPassiveEffects, finishedRoot, parentFiber, committedLanes, committedTransitions, includeWorkInProgressEffects), parentFiber = parentFiber.sibling;
    }
    ...
    function recursivelyTraverseAtomicPassiveEffects(finishedRoot, parentFiber, committedLanes, committedTransitions) {
      if (parentFiber.subtreeFlags & 10256)
        for (parentFiber = parentFiber.child;parentFiber !== null; )
          runWithFiberInDEV(parentFiber, commitAtomicPassiveEffects, finishedRoot, parentFiber, committedLanes, committedTransitions), parentFiber = parentFiber.sibling;
    }
    ...
    function recursivelyTraversePassiveUnmountEffects(parentFiber) {
      ...
      if (parentFiber.subtreeFlags & 10256)
        for (parentFiber = parentFiber.child;parentFiber !== null; )
          runWithFiberInDEV(parentFiber, commitPassiveUnmountOnFiber, parentFiber), parentFiber = parentFiber.sibling;
    }
    function commitPassiveUnmountOnFiber(finishedWork) {
      switch (finishedWork.tag) {
        ...
        case 22:
          var instance = finishedWork.stateNode;
          finishedWork.memoizedState !== null && instance._visibility & OffscreenPassiveEffectsConnected && (finishedWork.return === null || finishedWork.return.tag !== 13) ? (instance._visibility &= ~OffscreenPassiveEffectsConnected, recursivelyTraverseDisconnectPassiveEffects(finishedWork)) : recursivelyTraversePassiveUnmountEffects(finishedWork);
          break;
        default:
          recursivelyTraversePassiveUnmountEffects(finishedWork);
      }
        ...
        if (child !== null)
          ...
          a:
            for (fiber = deletedSubtreeRoot;nextEffect !== null; ) {
              child = nextEffect;
              var { sibling, return: returnFiber } = child;
        ...
        a:
          switch (type) {
            ...
            case REACT_STRICT_MODE_TYPE:
              ...
              break;
            case REACT_PROFILER_TYPE:
              return owner = mode, typeof pendingProps.id !== "string" && error$jscomp$0('Profiler must specify an "id" of type `string` as a prop. Received the type `%s` instead.', typeof pendingProps.id), owner = createFiber(12, pendingProps, key, owner | 2), owner.elementType = REACT_PROFILER_TYPE, owner.lanes = lanes, owner.stateNode = {
                effectDuration: 0,
            ...
            default:
              ...
              type === null ? type = "null" : isArrayImpl(type) ? type = "array" : type !== undefined && type.$$typeof === REACT_ELEMENT_TYPE ? (type = "<" + (getComponentNameFromType(type.type) || "Unknown") + " />", lanes = " Did you accidentally export a JSX literal instead of a component?") : type = typeof type;
      ...
      var primaryChildInstance = {
        ...
        detach: function() {
          ...
          if ((instance._pendingVisibility & OffscreenDetached) === 0) {
            var root2 = enqueueConcurrentRenderForLane(fiber, SyncLane);
            root2 !== null && (instance._pendingVisibility |= OffscreenDetached, scheduleUpdateOnFiber(root2, fiber, SyncLane));
          }
        },
        attach: function() {
          var instance = primaryChildInstance, fiber = instance._current;
    ...
    function scheduleRetryEffect(workInProgress2, retryQueue) {
      retryQueue !== null ? workInProgress2.flags |= 4 : workInProgress2.flags & 16384 && (retryQueue = workInProgress2.tag !== 22 ? claimNextRetryLane() : OffscreenLane, workInProgress2.lanes |= retryQueue);
    }
    ...
    function bubbleProperties(completedWork) {
      ...
      else if ((completedWork.mode & 2) !== 0) {
    ...
    function completeWork(current2, workInProgress2, renderLanes2) {
      ...
      switch (workInProgress2.tag) {
                  ...
                  switch (renderLanes2) {
                    ...
                    default:
                      current2 = typeof newProps.is === "string" ? current2.createElement(renderLanes2, {
                        is: newProps.is
                      }) : current2.createElement(renderLanes2), renderLanes2.indexOf("-") === -1 && (renderLanes2 !== renderLanes2.toLowerCase() && error$jscomp$0("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", renderLanes2), Object.prototype.toString.call(current2) !== "[object HTMLUnknownElement]" || hasOwnProperty.call(warnedUnknownTags, renderLanes2) || (warnedUnknownTags[renderLanes2] = true, error$jscomp$0("The tag <%s> is unrecognized in this browser. If you meant to render a React component, start its name with an uppercase letter.", renderLanes2)));
                  }
              }
        ...
        case 13:
          ...
          if (current2 === null || current2.memoizedState !== null && current2.memoizedState.dehydrated !== null) {
            ...
            if (newProps !== null && newProps.dehydrated !== null) {
              if (current2 === null) {
                ...
                bubbleProperties(workInProgress2);
                (workInProgress2.mode & 2) !== 0 && newProps !== null && (_type = workInProgress2.child, _type !== null && (workInProgress2.treeBaseDuration -= _type.treeBaseDuration));
              } else
                emitPendingHydrationWarnings(), resetHydrationState(), (workInProgress2.flags & 128) === 0 && (workInProgress2.memoizedState = null), workInProgress2.flags |= 4, bubbleProperties(workInProgress2), (workInProgress2.mode & 2) !== 0 && newProps !== null && (_type = workInProgress2.child, _type !== null && (workInProgress2.treeBaseDuration -= _type.treeBaseDuration));
              _type = false;
            } else
          ...
          popSuspenseHandler(workInProgress2);
          if ((workInProgress2.flags & 128) !== 0)
            return workInProgress2.lanes = renderLanes2, (workInProgress2.mode & 2) !== 0 && transferActualDuration(workInProgress2), workInProgress2;
          ...
          bubbleProperties(workInProgress2);
          (workInProgress2.mode & 2) !== 0 && newProps && (current2 = workInProgress2.child, current2 !== null && (workInProgress2.treeBaseDuration -= current2.treeBaseDuration));
          return null;
        case 4:
    ...
    function unwindWork(current2, workInProgress2) {
      ...
      switch (workInProgress2.tag) {
        case 1:
          return current2 = workInProgress2.flags, current2 & 65536 ? (workInProgress2.flags = current2 & -65537 | 128, (workInProgress2.mode & 2) !== 0 && transferActualDuration(workInProgress2), workInProgress2) : null;
        case 3:
        ...
        case 13:
          ...
          return current2 & 65536 ? (workInProgress2.flags = current2 & -65537 | 128, (workInProgress2.mode & 2) !== 0 && transferActualDuration(workInProgress2), workInProgress2) : null;
        case 19:
        ...
        case 22:
        case 23:
          return popSuspenseHandler(workInProgress2), popHiddenContext(workInProgress2), current2 !== null && pop(resumedCache, workInProgress2), current2 = workInProgress2.flags, current2 & 65536 ? (workInProgress2.flags = current2 & -65537 | 128, (workInProgress2.mode & 2) !== 0 && transferActualDuration(workInProgress2), workInProgress2) : null;
        case 24:
    ...
    function isConcurrentActEnvironment() {
      ...
      isReactActEnvironmentGlobal || ReactSharedInternals.actQueue === null || error$jscomp$0("The current testing environment is not configured to support act(...)");
    ...
    function requestDeferredLane() {
      workInProgressDeferredLane === 0 && (workInProgressDeferredLane = (workInProgressRootRenderLanes & OffscreenLane) === 0 || isHydrating ? claimNextTransitionLane() : OffscreenLane);
    ...
    function scheduleUpdateOnFiber(root2, fiber, lane) {
      ...
      if (root2 === workInProgressRoot && workInProgressSuspendedReason === SuspendedOnData || root2.cancelPendingCommit !== null)
        prepareFreshStack(root2, 0), markRootSuspended(root2, workInProgressRootRenderLanes, workInProgressDeferredLane);
        ...
        if (isRendering)
          switch (fiber.tag) {
            ...
            case 15:
              ...
              didWarnAboutUpdateInRenderForAnotherComponent.has(root2) || (didWarnAboutUpdateInRenderForAnotherComponent.add(root2), fiber = getComponentNameFromFiber(fiber) || "Unknown", error$jscomp$0("Cannot update a component (`%s`) while rendering a different component (`%s`). To locate the bad setState() call inside `%s`, follow the stack trace as described in https://react.dev/link/setstate-in-render", fiber, root2, root2));
              break;
            case 1:
              didWarnAboutUpdateInRender || (error$jscomp$0("Cannot update during an existing state transition (such as within `render`). Render methods should be a pure function of props and state."), didWarnAboutUpdateInRender = true);
          }
      } else
    ...
    function performConcurrentWorkOnRoot(root2, didTimeout) {
      ...
      if (flushPassiveEffects() && root2.callbackNode !== originalCallbackNode)
        return null;
      var lanes = getNextLanes(root2, root2 === workInProgressRoot ? workInProgressRootRenderLanes : 0);
      if (lanes === 0)
        return null;
      var shouldTimeSlice = (lanes & (InputContinuousHydrationLane | InputContinuousLane | DefaultHydrationLane | DefaultLane)) === 0 && (lanes & root2.expiredLanes) === 0 && !didTimeout;
        ...
        do {
          if (didTimeout === RootDidNotComplete)
            ...
            if (didTimeout === RootErrored) {
              ...
              var errorRetryLanes = getLanesToRetrySynchronouslyOnError(root2, renderWasConcurrent);
              if (errorRetryLanes !== 0 && (lanes = errorRetryLanes, didTimeout = recoverFromConcurrentError(root2, renderWasConcurrent, errorRetryLanes), renderWasConcurrent = false, didTimeout !== RootErrored))
                continue;
            }
            ...
            a: {
              ...
              if (ReactSharedInternals.actQueue !== null)
                commitRoot(renderWasConcurrent, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, workInProgressDeferredLane);
              else {
                if ((lanes & RetryLanes) === lanes && (didTimeout = globalMostRecentFallbackTime + FALLBACK_THROTTLE_MS - now$1(), 10 < didTimeout)) {
                  markRootSuspended(renderWasConcurrent, lanes, workInProgressDeferredLane);
                  if (getNextLanes(renderWasConcurrent, 0) !== 0)
                    break a;
    ...
    function recoverFromConcurrentError(root2, originallyAttemptedLanes, errorRetryLanes) {
      ...
      if (errorRetryLanes !== RootErrored) {
        ...
        root2 !== null && queueRecoverableErrors(root2);
      }
    ...
    function commitRootWhenReady(root2, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane) {
      ...
      if (subtreeFlags & 8192 || (subtreeFlags & 16785408) === 16785408) {
        if (suspendedState = { stylesheets: null, count: 0, unsuspend: noop }, accumulateSuspenseyCommitOnFiber(finishedWork), finishedWork = waitForCommitToBeReady(), finishedWork !== null) {
          root2.cancelPendingCommit = finishedWork(commitRoot.bind(null, root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate));
          markRootSuspended(root2, lanes, spawnedLane);
          return;
        }
      }
      commitRoot(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane);
    }
    ...
    function performSyncWorkOnRoot(root2, lanes) {
      ...
      if (exitStatus === RootErrored) {
        var originallyAttemptedLanes = lanes, errorRetryLanes = getLanesToRetrySynchronouslyOnError(root2, originallyAttemptedLanes);
        errorRetryLanes !== 0 && (lanes = errorRetryLanes, exitStatus = recoverFromConcurrentError(root2, originallyAttemptedLanes, errorRetryLanes));
      }
      ...
      root2.finishedLanes = lanes;
      commitRoot(root2, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, workInProgressDeferredLane);
      ensureRootIsScheduled(root2);
      return null;
    }
    ...
    function prepareFreshStack(root2, lanes) {
      ...
      (lanes & InputContinuousLane) !== 0 && (lanes |= lanes & DefaultLane);
    ...
    function shouldRemainOnPreviousScreen() {
      ...
      return handler === null ? true : (workInProgressRootRenderLanes & TransitionLanes) === workInProgressRootRenderLanes ? shellBoundary === null ? true : false : (workInProgressRootRenderLanes & RetryLanes) === workInProgressRootRenderLanes || (workInProgressRootRenderLanes & OffscreenLane) !== 0 ? handler === shellBoundary : false;
    }
    ...
    function renderDidSuspendDelayIfPossible() {
      ...
      (workInProgressRootSkippedLanes & 134217727) === 0 && (workInProgressRootInterleavedUpdatedLanes & 134217727) === 0 || workInProgressRoot === null || markRootSuspended(workInProgressRoot, workInProgressRootRenderLanes, workInProgressDeferredLane);
    }
          ...
          try {
            if (workInProgressSuspendedReason !== NotSuspended && workInProgress !== null) {
              ...
              switch (workInProgressSuspendedReason) {
                ...
                case SuspendedOnImmediate:
                case SuspendedOnData:
                  lanes || suspenseHandlerStackCursor.current !== null || (lanes = true);
                default:
            ...
            handleThrow(root2, thrownValue$45);
          }
        while (1);
    ...
    function performUnitOfWork(unitOfWork) {
      ...
      (unitOfWork.mode & 2) !== 0 ? (startProfilerTimer(unitOfWork), current2 = runWithFiberInDEV(unitOfWork, beginWork, current2, unitOfWork, entangledRenderLanes), stopProfilerTimerIfRunningAndRecordDelta(unitOfWork, true)) : current2 = runWithFiberInDEV(unitOfWork, beginWork, current2, unitOfWork, entangledRenderLanes);
    ...
    function replayBeginWork(unitOfWork) {
      var current2 = unitOfWork.alternate, isProfilingMode = (unitOfWork.mode & 2) !== 0;
        ...
        a: {
          ...
          do {
            ...
            if ((root2.mode & 2) !== 0) {
              ...
              for (thrownValue = root2.child;thrownValue !== null; )
                unitOfWork += thrownValue.actualDuration, thrownValue = thrownValue.sibling;
              root2.actualDuration = unitOfWork;
            }
            root2 = root2.return;
            root2 !== null && (root2.flags |= 32768, root2.subtreeFlags = 0, root2.deletions = null);
    ...
    function completeUnitOfWork(unitOfWork) {
      ...
      do {
        (completedWork.flags & 32768) !== 0 && error$jscomp$0("Internal React error: Expected this fiber to be complete, but it isn't. It should have been unwound. This is a bug in React.");
        var current2 = completedWork.alternate;
        unitOfWork = completedWork.return;
        (completedWork.mode & 2) === 0 ? current2 = runWithFiberInDEV(completedWork, completeWork, current2, completedWork, entangledRenderLanes) : (startProfilerTimer(completedWork), current2 = runWithFiberInDEV(completedWork, completeWork, current2, completedWork, entangledRenderLanes), stopProfilerTimerIfRunningAndRecordDelta(completedWork, false));
        if (current2 !== null) {
    ...
    function commitRoot(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane) {
      ...
      try {
        ReactDOMSharedInternals.p = DiscreteEventPriority, ReactSharedInternals.T = null, commitRootImpl(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, previousUpdateLanePriority, spawnedLane);
      } finally {
    ...
    function commitRootImpl(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, renderPriorityLevel, spawnedLane) {
      ...
      lanes === 0 && error$jscomp$0("root.finishedLanes should not be empty during a commit. This is a bug in React.");
      root2.finishedWork = null;
      root2.finishedLanes = 0;
      ...
      if ((finishedWork.subtreeFlags & 15990) !== 0 || transitions) {
      ...
      (pendingPassiveEffectsLanes & (SyncLane | SyncHydrationLane)) !== 0 && flushPassiveEffects();
      remainingLanes = root2.pendingLanes;
      didIncludeRenderPhaseUpdate || didIncludeCommitPhaseUpdate || (lanes & UpdateLanes) !== 0 && (remainingLanes & SyncUpdateLanes) !== 0 ? (nestedUpdateScheduled = true, root2 === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root2)) : nestedUpdateCount = 0;
        ...
        try {
          ...
          if (rootWithPendingPassiveEffects === null)
            ...
            for (finishedWork$jscomp$0 = 0;finishedWork$jscomp$0 < finishedWork.length; finishedWork$jscomp$0++) {
              ...
              if (executionContext & CommitContext && (finishedWork$jscomp$1.flags & 4) !== 0)
                switch (finishedWork$jscomp$1.tag) {
                  case 12:
                    ...
                    var phase = finishedWork$jscomp$1.alternate === null ? "mount" : "update";
                    currentUpdateIsNested && (phase = "nested-update");
                    typeof onPostCommit === "function" && onPostCommit(id, phase, passiveEffectDuration, transitions);
    ...
    function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error) {
      ...
      rootFiber !== null && (markRootUpdated(rootFiber, SyncLane), ensureRootIsScheduled(rootFiber));
    }
        ...
        for (;nearestMountedAncestor !== null; ) {
          ...
          if (nearestMountedAncestor.tag === 1) {
            ...
            if (typeof nearestMountedAncestor.type.getDerivedStateFromError === "function" || typeof instance.componentDidCatch === "function" && (legacyErrorBoundariesThatAlreadyFailed === null || !legacyErrorBoundariesThatAlreadyFailed.has(instance))) {
              ...
              instance !== null && (initializeClassErrorUpdate(error$1, instance, nearestMountedAncestor, sourceFiber), markRootUpdated(instance, SyncLane), ensureRootIsScheduled(instance));
              return;
            }
          }
    ...
    function pingSuspendedRoot(root2, wakeable, pingedLanes) {
      ...
      executionContext & RenderContext ? workInProgressRootDidIncludeRecursiveRenderUpdate = true : executionContext & CommitContext && (didIncludeCommitPhaseUpdate = true);
      throwIfInfiniteUpdateLoopDetected();
      isConcurrentActEnvironment() && ReactSharedInternals.actQueue === null && error$jscomp$0("A suspended resource finished loading inside a test, but the event was not wrapped in act(...).\n\nWhen testing, code that resolves suspended data should be wrapped into act(...):\n\nact(() => {\n  /* finish loading suspended data */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act");
    ...
    function retryTimedOutBoundary(boundaryFiber, retryLane) {
      ...
      boundaryFiber !== null && (markRootUpdated(boundaryFiber, retryLane), ensureRootIsScheduled(boundaryFiber));
    }
    ...
    function throwIfInfiniteUpdateLoopDetected() {
      if (nestedUpdateCount > NESTED_UPDATE_LIMIT)
        throw nestedPassiveUpdateCount = nestedUpdateCount = 0, rootWithPassiveNestedUpdates = rootWithNestedUpdates = null, executionContext & RenderContext && workInProgressRoot !== null && (workInProgressRoot.errorRecoveryDisabledLanes |= workInProgressRootRenderLanes), Error("Maximum update depth exceeded. This can happen when a component repeatedly calls setState inside componentWillUpdate or componentDidUpdate. React limits the number of nested updates to prevent infinite loops.");
      ...
      if (!isFlushingWork && mightHavePendingSyncWork) {
        ...
        do {
          ...
          for (var root2 = firstScheduledRoot;root2 !== null; ) {
            ...
            (workInProgressRootRenderLanes$jscomp$0 & (SyncLane | SyncHydrationLane)) !== 0 && (didPerformSomeWork = true, performSyncWorkOnRoot(root2, workInProgressRootRenderLanes$jscomp$0));
            root2 = root2.next;
          }
    ...
    function processRootScheduleInMicrotask() {
      ...
      for (var currentTime = now$1(), prev = null, root2 = firstScheduledRoot;root2 !== null; ) {
        var next = root2.next;
        if (currentEventTransitionLane !== 0 && shouldAttemptEagerTransition()) {
        ...
        root$jscomp$0 === 0 ? (root2.next = null, prev === null ? firstScheduledRoot = next : prev.next = next, next === null && (lastScheduledRoot = prev)) : (prev = root2, (root$jscomp$0 & (SyncLane | SyncHydrationLane)) !== 0 && (mightHavePendingSyncWork = true));
        root2 = next;
      }
    ...
    function scheduleTaskForRootDuringMicrotask(root2, currentTime) {
      for (var { suspendedLanes, pingedLanes, expirationTimes } = root2, lanes = root2.pendingLanes & ~RetryLanes;0 < lanes; ) {
      ...
      if ((suspendedLanes & (SyncLane | SyncHydrationLane)) !== 0)
        return pingedLanes !== null && cancelCallback(pingedLanes), root2.callbackPriority = SyncLane, root2.callbackNode = null, SyncLane;
    ...
    function validatePropertiesInDevelopment(type, props) {
      ...
      type !== "input" && type !== "textarea" && type !== "select" || props == null || props.value !== null || didWarnValueNull || (didWarnValueNull = true, type === "select" && props.multiple ? error$jscomp$0("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.", type) : error$jscomp$0("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.", type));
      var eventRegistry = {
        registrationNameDependencies,
        possibleRegistrationNames
      };
      isCustomElement(type) || typeof props.is === "string" || warnUnknownProperties(type, props, eventRegistry);
      props.contentEditable && !props.suppressContentEditableWarning && props.children != null && error$jscomp$0("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional.");
    }
    ...
    function setProp(domElement, tag, key, value, props, prevValue) {
      switch (key) {
        ...
        case "action":
        case "formAction":
          value != null && (tag === "form" ? key === "formAction" ? error$jscomp$0("You can only pass the formAction prop to <input> or <button>. Use the action prop on <form>.") : typeof value === "function" && (props.encType == null && props.method == null || didWarnFormActionMethod || (didWarnFormActionMethod = true, error$jscomp$0("Cannot specify a encType or method for a form that specifies a function as the action. React provides those automatically. They will get overridden.")), props.target == null || didWarnFormActionTarget || (didWarnFormActionTarget = true, error$jscomp$0("Cannot specify a target for a form that specifies a function as the action. The function will always be executed in the same window."))) : tag === "input" || tag === "button" ? key === "action" ? error$jscomp$0("You can only pass the action prop to <form>. Use the formAction prop on <input> or <button>.") : tag !== "input" || props.type === "submit" || props.type === "image" || didWarnFormActionType ? tag !== "button" || props.type == null || props.type === "submit" || didWarnFormActionType ? typeof value === "function" && (props.name == null || didWarnFormActionName || (didWarnFormActionName = true, error$jscomp$0('Cannot specify a "name" prop for a button that specifies a function as a formAction. React needs it to encode which action should be invoked. It will get overridden.')), props.formEncType == null && props.formMethod == null || didWarnFormActionMethod || (didWarnFormActionMethod = true, error$jscomp$0("Cannot specify a formEncType or formMethod for a button that specifies a function as a formAction. React provides those automatically. They will get overridden.")), props.formTarget == null || didWarnFormActionTarget || (didWarnFormActionTarget = true, error$jscomp$0("Cannot specify a formTarget for a button that specifies a function as a formAction. The function will always be executed in the same window."))) : (didWarnFormActionType = true, error$jscomp$0('A button can only specify a formAction along with type="submit" or no type.')) : (didWarnFormActionType = true, error$jscomp$0('An input can only specify a formAction along with type="submit" or type="image".')) : key === "action" ? error$jscomp$0("You can only pass the action prop to <form>.") : error$jscomp$0("You can only pass the formAction prop to <input> or <button>."));
        ...
        case "preserveAlpha":
          ...
          break;
        case "inert":
          value !== "" || didWarnForNewBooleanPropsWithEmptyValue[key] || (didWarnForNewBooleanPropsWithEmptyValue[key] = true, error$jscomp$0("Received an empty string for a boolean attribute `%s`. This will treat the attribute as if it were false. Either pass `false` to silence this warning, or pass `true` if you used an empty string in earlier versions of React to indicate this attribute is true.", key));
        case "allowFullScreen":
        case "async":
        case "autoPlay":
        case "controls":
        ...
        case "xmlSpace":
          ...
          break;
        case "is":
          prevValue != null && error$jscomp$0('Cannot update the "is" prop after it has been initialized.');
        ...
        case "textContent":
          break;
        case "popoverTarget":
          didWarnPopoverTargetObject || value == null || typeof value !== "object" || (didWarnPopoverTargetObject = true, error$jscomp$0("The `popoverTarget` prop expects the ID of an Element as a string. Received %s instead.", value));
        default:
    ...
    function setInitialProperties(domElement, tag, props) {
      ...
      switch (tag) {
        ...
        case "select":
          ...
          for (name in props)
            if (props.hasOwnProperty(name) && (defaultValue = props[name], defaultValue != null))
              switch (name) {
                case "value":
                  value = defaultValue;
                  break;
          ...
          tag != null ? updateOptions(domElement, !!propKey, tag, false) : props != null && updateOptions(domElement, !!propKey, props, true);
          return;
        case "textarea":
          ...
          for (type in props)
            if (props.hasOwnProperty(type) && (defaultValue = props[type], defaultValue != null))
              switch (type) {
                case "value":
                  propKey = defaultValue;
                  break;
        ...
        case "option":
          ...
          for (defaultValue in props)
            if (props.hasOwnProperty(defaultValue) && (propKey = props[defaultValue], propKey != null))
              switch (defaultValue) {
                case "selected":
                  domElement.selected = propKey && typeof propKey !== "function" && typeof propKey !== "symbol";
                  break;
                default:
        ...
        case "menuitem":
          for (checked in props)
            if (props.hasOwnProperty(checked) && (propKey = props[checked], propKey != null))
              switch (checked) {
                case "children":
                case "dangerouslySetInnerHTML":
                  throw Error(tag + " is a void element tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");
        ...
        default:
          if (isCustomElement(tag)) {
            for (defaultChecked in props)
              props.hasOwnProperty(defaultChecked) && (propKey = props[defaultChecked], propKey !== undefined && setPropOnCustomElement(domElement, tag, defaultChecked, propKey, props, undefined));
            return;
          }
      }
      for (value in props)
        props.hasOwnProperty(value) && (propKey = props[value], propKey != null && setProp(domElement, tag, value, propKey, props, null));
    }
      ...
      switch (tag) {
        ...
        case "input":
          ...
          for (var _propKey7 in nextProps) {
            ...
            if (nextProps.hasOwnProperty(_propKey7) && (propKey != null || lastProp != null))
              switch (_propKey7) {
                case "type":
                  type = propKey;
                  break;
        ...
        case "select":
          ...
          tag = value;
          lastProps = propKey;
          _propKey7 != null ? updateOptions(domElement, !!tag, _propKey7, false) : !!lastProps !== !!tag && (nextProps != null ? updateOptions(domElement, !!tag, nextProps, true) : updateOptions(domElement, !!tag, tag ? [] : "", false));
          return;
        case "textarea":
        ...
        case "option":
          for (var _propKey12 in lastProps)
            if (_propKey7 = lastProps[_propKey12], lastProps.hasOwnProperty(_propKey12) && _propKey7 != null && !nextProps.hasOwnProperty(_propKey12))
              switch (_propKey12) {
                case "selected":
          ...
          for (lastDefaultValue in nextProps)
            if (_propKey7 = nextProps[lastDefaultValue], propKey = lastProps[lastDefaultValue], nextProps.hasOwnProperty(lastDefaultValue) && _propKey7 !== propKey && (_propKey7 != null || propKey != null))
              switch (lastDefaultValue) {
                case "selected":
                  domElement.selected = _propKey7 && typeof _propKey7 !== "function" && typeof _propKey7 !== "symbol";
                  break;
                default:
        ...
        case "menuitem":
          for (var _propKey14 in lastProps)
            _propKey7 = lastProps[_propKey14], lastProps.hasOwnProperty(_propKey14) && _propKey7 != null && !nextProps.hasOwnProperty(_propKey14) && setProp(domElement, tag, _propKey14, null, nextProps, _propKey7);
          for (checked in nextProps)
            if (_propKey7 = nextProps[checked], propKey = lastProps[checked], nextProps.hasOwnProperty(checked) && _propKey7 !== propKey && (_propKey7 != null || propKey != null))
              switch (checked) {
                case "children":
                case "dangerouslySetInnerHTML":
                  if (_propKey7 != null)
        ...
        default:
          if (isCustomElement(tag)) {
            for (var _propKey16 in lastProps)
              _propKey7 = lastProps[_propKey16], lastProps.hasOwnProperty(_propKey16) && _propKey7 !== undefined && !nextProps.hasOwnProperty(_propKey16) && setPropOnCustomElement(domElement, tag, _propKey16, undefined, nextProps, _propKey7);
            for (defaultChecked in nextProps)
              _propKey7 = nextProps[defaultChecked], propKey = lastProps[defaultChecked], !nextProps.hasOwnProperty(defaultChecked) || _propKey7 === propKey || _propKey7 === undefined && propKey === undefined || setPropOnCustomElement(domElement, tag, defaultChecked, _propKey7, nextProps, propKey);
            return;
          }
      }
      for (var _propKey18 in lastProps)
        _propKey7 = lastProps[_propKey18], lastProps.hasOwnProperty(_propKey18) && _propKey7 != null && !nextProps.hasOwnProperty(_propKey18) && setProp(domElement, tag, _propKey18, null, nextProps, _propKey7);
      for (lastProp in nextProps)
        _propKey7 = nextProps[lastProp], propKey = lastProps[lastProp], !nextProps.hasOwnProperty(lastProp) || _propKey7 === propKey || _propKey7 == null && propKey == null || setProp(domElement, tag, lastProp, _propKey7, nextProps, propKey);
    }
    ...
    function diffHydratedStyles(domElement, value$jscomp$0, serverDifferences) {
      if (value$jscomp$0 != null && typeof value$jscomp$0 !== "object")
        error$jscomp$0("The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + 'em'}} when using JSX.");
            ...
            if (registrationNameDependencies.hasOwnProperty(value))
              ...
              switch (value) {
                ...
                case "xmlSpace":
                  ...
                  continue;
                case "inert":
                  propKey !== "" || didWarnForNewBooleanPropsWithEmptyValue[value] || (didWarnForNewBooleanPropsWithEmptyValue[value] = true, error$jscomp$0("Received an empty string for a boolean attribute `%s`. This will treat the attribute as if it were false. Either pass `false` to silence this warning, or pass `true` if you used an empty string in earlier versions of React to indicate this attribute is true.", value));
    ...
    function isHostHoistableType(type, props, hostContext) {
      ...
      if (hostContext.context === HostContextNamespaceSvg || props.itemProp != null)
        return !outsideHostContainerContext || props.itemProp == null || type !== "meta" && type !== "title" && type !== "style" && type !== "link" && type !== "script" || error$jscomp$0("Cannot render a <%s> outside the main document if it has an `itemProp` prop. `itemProp` suggests the tag belongs to an `itemScope` which can appear anywhere in the DOM. If you were intending for React to hoist this <%s> remove the `itemProp` prop. Otherwise, try moving this tag into the <head> or <body> of the Document.", type, type), false;
      switch (type) {
        case "meta":
        case "title":
          return true;
        ...
        case "link":
          if (typeof props.rel !== "string" || typeof props.href !== "string" || props.href === "" || props.onLoad || props.onError) {
            ...
            outsideHostContainerContext && (typeof props.rel !== "string" || typeof props.href !== "string" || props.href === "" ? error$jscomp$0("Cannot render a <link> outside the main document without a `rel` and `href` prop. Try adding a `rel` and/or `href` prop to this <link> or moving the link into the <head> tag") : (props.onError || props.onLoad) && error$jscomp$0("Cannot render a <link> with onLoad or onError listeners outside the main document. Try removing onLoad={...} and onError={...} or moving it into the root <head> tag or somewhere in the <body>."));
            break;
          }
          switch (props.rel) {
            case "stylesheet":
              return type = props.precedence, props = props.disabled, typeof type !== "string" && outsideHostContainerContext && error$jscomp$0('Cannot render a <link rel="stylesheet" /> outside the main document without knowing its precedence. Consider adding precedence="default" or moving it into the root <head> tag.'), typeof type === "string" && props == null;
            default:
              return true;
          }
        case "script":
    ...
    function updateContainerImpl(rootFiber, lane, element, container, parentComponent, callback) {
      ...
      isRendering && current !== null && !didWarnAboutNestedUpdates && (didWarnAboutNestedUpdates = true, error$jscomp$0("Render methods should be a pure function of props and state; triggering nested component updates from render is not allowed. If necessary, trigger nested updates in componentDidUpdate.\n\nCheck the render method of %s.", getComponentNameFromFiber(current) || "Unknown"));
      container = createUpdate(lane);
      container.payload = { element };
      callback = callback === undefined ? null : callback;
      callback !== null && (typeof callback !== "function" && error$jscomp$0("Expected the last optional `callback` argument to be a function. Instead received: %s.", callback), container.callback = callback);
            ...
            if (fiber !== null)
              switch (fiber.tag) {
                case 3:
                  ...
                  break;
                case 13:
                  root2 = enqueueConcurrentRenderForLane(fiber, SyncLane), root2 !== null && scheduleUpdateOnFiber(root2, fiber, SyncLane), flushSyncWork$1(), markRetryLaneIfNotHydrated(fiber, SyncLane);
              }
    ...
    function attemptReplayContinuousQueuedEvent(queuedEvent) {
      ...
      for (var targetContainers = queuedEvent.targetContainers;0 < targetContainers.length; ) {
        ...
        if (nextBlockedOn === null) {
          ...
          currentReplayingEvent !== null && error$jscomp$0("Expected currently replaying event to be null. This error is likely caused by a bug in React. Please file an issue.");
          currentReplayingEvent = event;
          nextBlockedOn.target.dispatchEvent(nativeEventClone);
          currentReplayingEvent === null && error$jscomp$0("Expected currently replaying event to not be null. This error is likely caused by a bug in React. Please file an issue.");
    ...
    ReactStrictModeWarnings.recordLegacyContextWarning = function(fiber, instance) {
      ...
      strictRoot === null ? error$jscomp$0("Expected to find a StrictMode component in a strict mode tree. This error is likely caused by a bug in React. Please file an issue.") : !didWarnAboutLegacyContext.has(fiber.type) && (node = pendingLegacyContextWarning.get(strictRoot), fiber.type.contextTypes != null || fiber.type.childContextTypes != null || instance !== null && typeof instance.getChildContext === "function") && (node === undefined && (node = [], pendingLegacyContextWarning.set(strictRoot, node)), node.push(fiber));
    };
    ...
    var now = Scheduler.unstable_now, commitTime = 0, layoutEffectStartTime = -1, profilerStartTime = -1, passiveEffectStartTime = -1, currentUpdateIsNested = false, nestedUpdateScheduled = false, reportGlobalError = typeof reportError === "function" ? reportError : function(error) {
      if (typeof window === "object" && typeof window.ErrorEvent === "function") {
        var event = new window.ErrorEvent("error", {
          bubbles: true,
          cancelable: true,
    ...
    var globalDocument = typeof document === "undefined" ? null : document, tagCaches = null, suspendedState = null, LAST_PRECEDENCE = null, precedencesByRoot = null, NotPendingTransition = NotPending;
    var didWarnAboutNestedUpdates = false;
    var overrideHookState = null, overrideHookStateDeletePath = null, overrideHookStateRenamePath = null, overrideProps = null, overridePropsDeletePath = null, overridePropsRenamePath = null, scheduleUpdate = null, setErrorHandler = null, setSuspenseHandler = null;
    overrideHookState = function(fiber, id, path, value) {
      id = findHook(fiber, id);
      id !== null && (path = copyWithSetImpl(id.memoizedState, path, 0, value), id.memoizedState = path, id.baseState = path, fiber.memoizedProps = assign({}, fiber.memoizedProps), path = enqueueConcurrentRenderForLane(fiber, SyncLane), path !== null && scheduleUpdateOnFiber(path, fiber, SyncLane));
    };
    overrideHookStateDeletePath = function(fiber, id, path) {
      id = findHook(fiber, id);
      id !== null && (path = copyWithDeleteImpl(id.memoizedState, path, 0), id.memoizedState = path, id.baseState = path, fiber.memoizedProps = assign({}, fiber.memoizedProps), path = enqueueConcurrentRenderForLane(fiber, SyncLane), path !== null && scheduleUpdateOnFiber(path, fiber, SyncLane));
    };
    overrideHookStateRenamePath = function(fiber, id, oldPath, newPath) {
      id = findHook(fiber, id);
      id !== null && (oldPath = copyWithRename(id.memoizedState, oldPath, newPath), id.memoizedState = oldPath, id.baseState = oldPath, fiber.memoizedProps = assign({}, fiber.memoizedProps), oldPath = enqueueConcurrentRenderForLane(fiber, SyncLane), oldPath !== null && scheduleUpdateOnFiber(oldPath, fiber, SyncLane));
    };
    overrideProps = function(fiber, path, value) {
      fiber.pendingProps = copyWithSetImpl(fiber.memoizedProps, path, 0, value);
      fiber.alternate && (fiber.alternate.pendingProps = fiber.pendingProps);
      path = enqueueConcurrentRenderForLane(fiber, SyncLane);
      path !== null && scheduleUpdateOnFiber(path, fiber, SyncLane);
    };
    ...
    overridePropsRenamePath = function(fiber, oldPath, newPath) {
      ...
      oldPath !== null && scheduleUpdateOnFiber(oldPath, fiber, SyncLane);
    };
    ...
    ReactDOMHydrationRoot.prototype.render = ReactDOMRoot.prototype.render = function(children, JSCompiler_OptimizeArgumentsArray_p2) {
      ...
      typeof JSCompiler_OptimizeArgumentsArray_p2 === "function" ? error$jscomp$0("does not support the second callback argument. To execute a side effect after rendering, declare it in a component body with useEffect().") : isValidContainer(JSCompiler_OptimizeArgumentsArray_p2) ? error$jscomp$0("You passed a container to the second argument of root.render(...). You don't need to pass it again since you already passed it to create the root.") : typeof JSCompiler_OptimizeArgumentsArray_p2 !== "undefined" && error$jscomp$0("You passed a second argument to root.render(...) but it only accepts one argument.");
    ...
    ReactDOMHydrationRoot.prototype.unmount = ReactDOMRoot.prototype.unmount = function(JSCompiler_OptimizeArgumentsArray_p3) {
      typeof JSCompiler_OptimizeArgumentsArray_p3 === "function" && error$jscomp$0("does not support a callback argument. To execute a side effect after rendering, declare it in a component body with useEffect().");
    ...
    (function() {
      ...
      if (isomorphicReactPackageVersion !== "19.0.0-rc-c21bcd627b-20240624")
    ...
    typeof Map === "function" && Map.prototype != null && typeof Map.prototype.forEach === "function" && typeof Set === "function" && Set.prototype != null && typeof Set.prototype.clear === "function" && typeof Set.prototype.forEach === "function" || error$jscomp$0("React depends on Map and Set built-in types. Make sure that you load a polyfill in older browsers. https://react.dev/link/react-polyfills");
    ...
    exports.createRoot = function(container, options) {
      ...
      options !== null && options !== undefined && (options.hydrate ? warn("hydrate through createRoot is deprecated. Use ReactDOMClient.hydrateRoot(container, <App />) instead.") : typeof options === "object" && options !== null && options.$$typeof === REACT_ELEMENT_TYPE && error$jscomp$0("You passed a JSX element to createRoot. You probably meant to call root.render instead. Example usage:\n\n  let root = createRoot(domContainer);\n  root.render(<App />);"), options.unstable_strictMode === true && (isStrictMode = true), options.identifierPrefix !== undefined && (identifierPrefix = options.identifierPrefix), options.onUncaughtError !== undefined && (onUncaughtError = options.onUncaughtError), options.onCaughtError !== undefined && (onCaughtError = options.onCaughtError), options.onRecoverableError !== undefined && (onRecoverableError = options.onRecoverableError), options.unstable_transitionCallbacks !== undefined && (transitionCallbacks = options.unstable_transitionCallbacks));
      options = createFiberRoot(container, 1, false, null, null, isStrictMode, false, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, null);
    ...
    exports.hydrateRoot = function(container, initialChildren, options) {
      if (!isValidContainer(container))
        throw Error("Target container is not a DOM element.");
      warnIfReactDOMContainerInDEV(container);
      initialChildren === undefined && error$jscomp$0("Must provide initial children as second argument to hydrateRoot. Example usage: hydrateRoot(domContainer, <App />)");
      ...
      initialChildren = createFiberRoot(container, 1, true, initialChildren, options != null ? options : null, isStrictMode, false, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, formState);
